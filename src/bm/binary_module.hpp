...
namespace rebgn {
    ...
    inline ::futils::error::Error<> Varint::encode(::futils::binary::writer& w) const {
        if ((*this).prefix() == 0) {
            std::uint8_t tmp64 = 0;
            tmp64 = (*this).value();
            tmp64 |= std::uint8_t(0) << 6;
            if (!::futils::binary::write_num(w, tmp64, true)) {
                return ::futils::error::Error<>("encode: Varint::value: write bit field failed", ::futils::error::Category::lib);
            }
        }
        else if ((*this).prefix() == 1) {
            std::uint16_t tmp64 = 0;
            tmp64 = (*this).value();
            tmp64 |= std::uint16_t(1) << 14;
            if (!::futils::binary::write_num(w, tmp64, true)) {
                return ::futils::error::Error<>("encode: Varint::value: write bit field failed", ::futils::error::Category::lib);
            }
        }
        else if ((*this).prefix() == 2) {
            std::uint32_t tmp64 = 0;
            tmp64 = (*this).value();
            tmp64 |= std::uint32_t(2) << 30;
            if (!::futils::binary::write_num(w, tmp64, true)) {
                return ::futils::error::Error<>("encode: Varint::value: write bit field failed", ::futils::error::Category::lib);
            }
        }
    ...
    inline ::futils::error::Error<> Varint::decode(::futils::binary::reader& r) {
        ...
        if ((*this).prefix() == 0) {
            ...
            tmp66 &= ~(std::uint8_t(0x3) << 6);
            (*this).value(tmp66);
        }
        else if ((*this).prefix() == 1) {
            std::uint16_t tmp67 = 0;
            if (!::futils::binary::read_num(r, tmp67, true)) {
                return ::futils::error::Error<>("decode: Varint::value: read bit field failed", ::futils::error::Category::lib);
            }
            tmp67 &= ~(std::uint16_t(0x3) << 14);
            (*this).value(tmp67);
        }
        else if ((*this).prefix() == 2) {
    ...
    inline ::futils::error::Error<> String::encode(::futils::binary::writer& w) const {
        ...
        if (tmp_70_ != (*this).data.size()) {
            return ::futils::error::Error<>("encode: String::data: dynamic length is not compatible with its length; tmp_70_!=(*this).data.size()", ::futils::error::Category::lib);
        }
    ...
    inline ::futils::error::Error<> String::decode(::futils::binary::reader& r) {
        ...
        auto tmp_71_ = (*this).length.value();
        if (!r.read((*this).data, tmp_71_)) {
    ...
    inline ::futils::error::Error<> Storage::encode(::futils::binary::writer& w) const {
        auto tmp_72_ = static_cast<std::uint8_t>((*this).type);
        if (!::futils::binary::write_num(w, static_cast<std::uint8_t>(tmp_72_), true)) {
    ...
    inline ::futils::error::Error<> Storage::decode(::futils::binary::reader& r) {
        std::uint8_t tmp_73_ = 0;
        if (!::futils::binary::read_num(r, tmp_73_, true)) {
            return ::futils::error::Error<>("decode: Storage::type: read int failed", ::futils::error::Category::lib);
        }
        (*this).type = static_cast<StorageType>(tmp_73_);
        if (StorageType::INT == (*this).type) {
            if (!std::holds_alternative<union_struct_4>(union_variant_3)) {
                union_variant_3 = union_struct_4();
            }
    ...
    inline ::futils::error::Error<> Metadata::encode(::futils::binary::writer& w) const {
        ...
        auto tmp_74_ = (*this).len_exprs.value();
        if (tmp_74_ != (*this).expr_refs.size()) {
            return ::futils::error::Error<>("encode: Metadata::expr_refs: dynamic length is not compatible with its length; tmp_74_!=(*this).expr_refs.size()", ::futils::error::Category::lib);
        }
        for (auto& tmp_75_ : (*this).expr_refs) {
            if (auto err = tmp_75_.encode(w)) {
                return err;
            }
        }
        return ::futils::error::Error<>();
    ...
    inline ::futils::error::Error<> Metadata::decode(::futils::binary::reader& r) {
        ...
        for (size_t tmp_78_ = 0; tmp_78_ < tmp_76_; ++tmp_78_) {
            Varint tmp_77_;
            if (auto err = tmp_77_.decode(r)) {
                return err;
            }
            (*this).expr_refs.push_back(std::move(tmp_77_));
        }
        return ::futils::error::Error<>();
    }
    ...
    inline ::futils::error::Error<> Storages::encode(::futils::binary::writer& w) const {
        ...
        if (tmp_79_ != (*this).storages.size()) {
            return ::futils::error::Error<>("encode: Storages::storages: dynamic length is not compatible with its length; tmp_79_!=(*this).storages.size()", ::futils::error::Category::lib);
        }
        for (auto& tmp_80_ : (*this).storages) {
    ...
    inline ::futils::error::Error<> Storages::decode(::futils::binary::reader& r) {
        ...
        for (size_t tmp_83_ = 0; tmp_83_ < tmp_81_; ++tmp_83_) {
            ...
            (*this).storages.push_back(std::move(tmp_82_));
        }
        return ::futils::error::Error<>();
    }
    inline ::futils::error::Error<> StringRefs::encode(::futils::binary::writer& w) const {
        ...
        auto tmp_84_ = (*this).refs_length.value();
        if (tmp_84_ != (*this).refs.size()) {
            return ::futils::error::Error<>("encode: StringRefs::refs: dynamic length is not compatible with its length; tmp_84_!=(*this).refs.size()", ::futils::error::Category::lib);
        }
        for (auto& tmp_85_ : (*this).refs) {
    ...
    inline ::futils::error::Error<> StringRefs::decode(::futils::binary::reader& r) {
        ...
        for (size_t tmp_88_ = 0; tmp_88_ < tmp_86_; ++tmp_88_) {
            ...
            (*this).refs.push_back(std::move(tmp_87_));
        }
        return ::futils::error::Error<>();
    }
    inline ::futils::error::Error<> IdentIndexs::encode(::futils::binary::writer& w) const {
        ...
        if (tmp_89_ != (*this).refs.size()) {
            return ::futils::error::Error<>("encode: IdentIndexs::refs: dynamic length is not compatible with its length; tmp_89_!=(*this).refs.size()", ::futils::error::Category::lib);
        }
    ...
    inline ::futils::error::Error<> Code::encode(::futils::binary::writer& w) const {
        auto tmp_94_ = static_cast<std::uint8_t>((*this).op);
        ...
        if (AbstractOp::METADATA == (*this).op) {
            ...
            auto tmp_95_ = static_cast<std::uint8_t>(std::get<19>((*this).union_variant_14).bop);
            ...
            auto tmp_96_ = static_cast<std::uint8_t>(std::get<20>((*this).union_variant_14).uop);
    ...
    inline ::futils::error::Error<> Code::decode(::futils::binary::reader& r) {
        ...
        (*this).op = static_cast<AbstractOp>(tmp_97_);
        if (AbstractOp::METADATA == (*this).op) {
            if (!std::holds_alternative<union_struct_15>(union_variant_14)) {
                union_variant_14 = union_struct_15();
            }
            ...
            std::get<19>((*this).union_variant_14).bop = static_cast<BinaryOp>(tmp_98_);
            ...
            std::get<20>((*this).union_variant_14).uop = static_cast<UnaryOp>(tmp_99_);
    ...
    inline ::futils::error::Error<> BinaryModule::encode(::futils::binary::writer& w) const {
        ...
        auto tmp_100_ = (*this).code_length.value();
        if (tmp_100_ != (*this).code.size()) {
            return ::futils::error::Error<>("encode: BinaryModule::code: dynamic length is not compatible with its length; tmp_100_!=(*this).code.size()", ::futils::error::Category::lib);
        }
        for (auto& tmp_101_ : (*this).code) {
    ...
    inline ::futils::error::Error<> BinaryModule::decode(::futils::binary::reader& r) {
        ...
        auto tmp_103_ = (*this).code_length.value();
        (*this).code.clear();
        for (size_t tmp_105_ = 0; tmp_105_ < tmp_103_; ++tmp_105_) {
            ...
            (*this).code.push_back(std::move(tmp_104_));
        }
        return ::futils::error::Error<>();
    }
}  // namespace rebgn
