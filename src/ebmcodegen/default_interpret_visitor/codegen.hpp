...
#elif __has_include("src/ebmcodegen/default_interpret_visitor/visitorincludes_before.hpp")
#include "src/ebmcodegen/default_interpret_visitor/visitorincludes_before.hpp"
#endif
...
#elif __has_include("src/ebmcodegen/default_interpret_visitor/visitorincludes.hpp")
#include "src/ebmcodegen/default_interpret_visitor/visitorincludes.hpp"
#endif
...
#elif __has_include("src/ebmcodegen/default_interpret_visitor/visitorincludes_after.hpp")
#include "src/ebmcodegen/default_interpret_visitor/visitorincludes_after.hpp"
#endif
namespace ebm2all {
    ...
    struct Result {
        ...
        #elif __has_include("src/ebmcodegen/default_interpret_visitor/visitorResult_before.hpp")
        #include "src/ebmcodegen/default_interpret_visitor/visitorResult_before.hpp"
        #endif
        ...
        #elif __has_include("src/ebmcodegen/default_interpret_visitor/visitorResult.hpp")
        #include "src/ebmcodegen/default_interpret_visitor/visitorResult.hpp"
        #endif
        ...
        #elif __has_include("src/ebmcodegen/default_interpret_visitor/visitorResult_after.hpp")
        #include "src/ebmcodegen/default_interpret_visitor/visitorResult_after.hpp"
        #endif
    };
    struct Flags : ebmcodegen::Flags {
        ...
        #elif __has_include("src/ebmcodegen/default_interpret_visitor/visitorFlags_before.hpp")
        #include "src/ebmcodegen/default_interpret_visitor/visitorFlags_before.hpp"
        #endif
        ...
        #elif __has_include("src/ebmcodegen/default_interpret_visitor/visitorFlags.hpp")
        #include "src/ebmcodegen/default_interpret_visitor/visitorFlags.hpp"
        #endif
        ...
        #elif __has_include("src/ebmcodegen/default_interpret_visitor/visitorFlags_after.hpp")
        #include "src/ebmcodegen/default_interpret_visitor/visitorFlags_after.hpp"
        #endif
        #undef DEFINE_FLAG
        #undef WEB_FILTERED
        ...
        #elif __has_include("src/ebmcodegen/default_interpret_visitor/visitorFlags_struct_before.hpp")
        #include "src/ebmcodegen/default_interpret_visitor/visitorFlags_struct_before.hpp"
        #endif
        ...
        #elif __has_include("src/ebmcodegen/default_interpret_visitor/visitorFlags_struct.hpp")
        #include "src/ebmcodegen/default_interpret_visitor/visitorFlags_struct.hpp"
        #endif
        ...
        #elif __has_include("src/ebmcodegen/default_interpret_visitor/visitorFlags_struct_after.hpp")
        #include "src/ebmcodegen/default_interpret_visitor/visitorFlags_struct_after.hpp"
        #endif
        void bind(futils::cmdline::option::Context& ctx) {
            ...
            #elif __has_include("src/ebmcodegen/default_interpret_visitor/visitorFlags_bind_before.hpp")
            #include "src/ebmcodegen/default_interpret_visitor/visitorFlags_bind_before.hpp"
            #endif
            ...
            #elif __has_include("src/ebmcodegen/default_interpret_visitor/visitorFlags_bind.hpp")
            #include "src/ebmcodegen/default_interpret_visitor/visitorFlags_bind.hpp"
            #endif
            ...
            #elif __has_include("src/ebmcodegen/default_interpret_visitor/visitorFlags_bind_after.hpp")
            #include "src/ebmcodegen/default_interpret_visitor/visitorFlags_bind_after.hpp"
            #endif
        }
    };
    ...
    #elif __has_include("src/ebmcodegen/default_interpret_visitor/visitorOutput_before.hpp")
    #include "src/ebmcodegen/default_interpret_visitor/visitorOutput_before.hpp"
    #endif
    ...
    #elif __has_include("src/ebmcodegen/default_interpret_visitor/visitorOutput.hpp")
    #include "src/ebmcodegen/default_interpret_visitor/visitorOutput.hpp"
    #endif
    ...
    #elif __has_include("src/ebmcodegen/default_interpret_visitor/visitorOutput_after.hpp")
    #include "src/ebmcodegen/default_interpret_visitor/visitorOutput_after.hpp"
    #endif
    };
    ...
    struct BaseVisitor {
        ...
        #elif __has_include("src/ebmcodegen/default_interpret_visitor/visitorVisitor_before.hpp")
        #include "src/ebmcodegen/default_interpret_visitor/visitorVisitor_before.hpp"
        #endif
        ...
        #elif __has_include("src/ebmcodegen/default_interpret_visitor/visitorVisitor.hpp")
        #include "src/ebmcodegen/default_interpret_visitor/visitorVisitor.hpp"
        #endif
        ...
        #elif __has_include("src/ebmcodegen/default_interpret_visitor/visitorVisitor_after.hpp")
        #include "src/ebmcodegen/default_interpret_visitor/visitorVisitor_after.hpp"
        #endif
    };
    template<typename V>
    ...
    // Deconstruct context fields
    #define EBM2ALL_DECONSTRUCT_STATEMENT_RESERVE_DATA(instance_name) \
    ...
    // Deconstruct context fields
    #define EBM2ALL_DECONSTRUCT_STATEMENT_RESERVE_DATA_BEFORE(instance_name) \
    ...
    // Deconstruct context fields
    #define EBM2ALL_DECONSTRUCT_STATEMENT_RESERVE_DATA_AFTER(instance_name) \
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_entry_before ebm2all::Context_entry_before<Result>
    #define EBM2ALL_CODEGEN_VISITOR_entry_after ebm2all::Visitor<ebm2all::UserHook<ebm2all::VisitorTag_entry_after>>
    #define EBM2ALL_CODEGEN_CONTEXT_entry_after ebm2all::Context_entry_after<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Statement_BLOCK_before ebm2all::Context_Statement_BLOCK_before<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Statement_BLOCK_after ebm2all::Context_Statement_BLOCK_after<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Statement_ASSIGNMENT_before ebm2all::Context_Statement_ASSIGNMENT_before<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Statement_ASSIGNMENT_after ebm2all::Context_Statement_ASSIGNMENT_after<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Statement_YIELD_before ebm2all::Context_Statement_YIELD_before<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Statement_YIELD_after ebm2all::Context_Statement_YIELD_after<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Statement_APPEND_before ebm2all::Context_Statement_APPEND_before<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Statement_APPEND_after ebm2all::Context_Statement_APPEND_after<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Statement_RETURN_before ebm2all::Context_Statement_RETURN_before<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Statement_RETURN_after ebm2all::Context_Statement_RETURN_after<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Statement_ERROR_RETURN_before ebm2all::Context_Statement_ERROR_RETURN_before<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Statement_ERROR_RETURN_after ebm2all::Context_Statement_ERROR_RETURN_after<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Statement_ASSERT_before ebm2all::Context_Statement_ASSERT_before<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Statement_ASSERT_after ebm2all::Context_Statement_ASSERT_after<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Statement_READ_DATA_before ebm2all::Context_Statement_READ_DATA_before<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Statement_READ_DATA_after ebm2all::Context_Statement_READ_DATA_after<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Statement_WRITE_DATA_before ebm2all::Context_Statement_WRITE_DATA_before<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Statement_WRITE_DATA_after ebm2all::Context_Statement_WRITE_DATA_after<Result>
    #define EBM2ALL_CODEGEN_VISITOR_Statement_RESERVE_DATA ebm2all::Visitor<ebm2all::UserHook<ebm2all::VisitorTag_Statement_RESERVE_DATA>>
    #define EBM2ALL_CODEGEN_CONTEXT_Statement_RESERVE_DATA ebm2all::Context_Statement_RESERVE_DATA
    #define EBM2ALL_CODEGEN_VISITOR_Statement_RESERVE_DATA_before ebm2all::Visitor<ebm2all::UserHook<ebm2all::VisitorTag_Statement_RESERVE_DATA_before>>
    #define EBM2ALL_CODEGEN_CONTEXT_Statement_RESERVE_DATA_before ebm2all::Context_Statement_RESERVE_DATA_before<Result>
    #define EBM2ALL_CODEGEN_VISITOR_Statement_RESERVE_DATA_after ebm2all::Visitor<ebm2all::UserHook<ebm2all::VisitorTag_Statement_RESERVE_DATA_after>>
    #define EBM2ALL_CODEGEN_CONTEXT_Statement_RESERVE_DATA_after ebm2all::Context_Statement_RESERVE_DATA_after<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Statement_IF_STATEMENT_before ebm2all::Context_Statement_IF_STATEMENT_before<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Statement_IF_STATEMENT_after ebm2all::Context_Statement_IF_STATEMENT_after<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Statement_LOOP_STATEMENT_before ebm2all::Context_Statement_LOOP_STATEMENT_before<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Statement_LOOP_STATEMENT_after ebm2all::Context_Statement_LOOP_STATEMENT_after<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Statement_MATCH_STATEMENT_before ebm2all::Context_Statement_MATCH_STATEMENT_before<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Statement_MATCH_STATEMENT_after ebm2all::Context_Statement_MATCH_STATEMENT_after<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Statement_MATCH_BRANCH_before ebm2all::Context_Statement_MATCH_BRANCH_before<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Statement_MATCH_BRANCH_after ebm2all::Context_Statement_MATCH_BRANCH_after<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Statement_BREAK_before ebm2all::Context_Statement_BREAK_before<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Statement_BREAK_after ebm2all::Context_Statement_BREAK_after<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Statement_CONTINUE_before ebm2all::Context_Statement_CONTINUE_before<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Statement_CONTINUE_after ebm2all::Context_Statement_CONTINUE_after<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Statement_FUNCTION_DECL_before ebm2all::Context_Statement_FUNCTION_DECL_before<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Statement_FUNCTION_DECL_after ebm2all::Context_Statement_FUNCTION_DECL_after<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Statement_VARIABLE_DECL_before ebm2all::Context_Statement_VARIABLE_DECL_before<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Statement_VARIABLE_DECL_after ebm2all::Context_Statement_VARIABLE_DECL_after<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Statement_PARAMETER_DECL_before ebm2all::Context_Statement_PARAMETER_DECL_before<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Statement_PARAMETER_DECL_after ebm2all::Context_Statement_PARAMETER_DECL_after<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Statement_FIELD_DECL_before ebm2all::Context_Statement_FIELD_DECL_before<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Statement_FIELD_DECL_after ebm2all::Context_Statement_FIELD_DECL_after<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Statement_COMPOSITE_FIELD_DECL_before ebm2all::Context_Statement_COMPOSITE_FIELD_DECL_before<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Statement_COMPOSITE_FIELD_DECL_after ebm2all::Context_Statement_COMPOSITE_FIELD_DECL_after<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Statement_ENUM_DECL_before ebm2all::Context_Statement_ENUM_DECL_before<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Statement_ENUM_DECL_after ebm2all::Context_Statement_ENUM_DECL_after<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Statement_ENUM_MEMBER_DECL_before ebm2all::Context_Statement_ENUM_MEMBER_DECL_before<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Statement_ENUM_MEMBER_DECL_after ebm2all::Context_Statement_ENUM_MEMBER_DECL_after<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Statement_STRUCT_DECL_before ebm2all::Context_Statement_STRUCT_DECL_before<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Statement_STRUCT_DECL_after ebm2all::Context_Statement_STRUCT_DECL_after<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Statement_UNION_DECL_before ebm2all::Context_Statement_UNION_DECL_before<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Statement_UNION_DECL_after ebm2all::Context_Statement_UNION_DECL_after<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Statement_UNION_MEMBER_DECL_before ebm2all::Context_Statement_UNION_MEMBER_DECL_before<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Statement_UNION_MEMBER_DECL_after ebm2all::Context_Statement_UNION_MEMBER_DECL_after<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Statement_PROGRAM_DECL_before ebm2all::Context_Statement_PROGRAM_DECL_before<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Statement_PROGRAM_DECL_after ebm2all::Context_Statement_PROGRAM_DECL_after<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Statement_PROPERTY_DECL_before ebm2all::Context_Statement_PROPERTY_DECL_before<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Statement_PROPERTY_DECL_after ebm2all::Context_Statement_PROPERTY_DECL_after<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Statement_PROPERTY_MEMBER_DECL_before ebm2all::Context_Statement_PROPERTY_MEMBER_DECL_before<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Statement_PROPERTY_MEMBER_DECL_after ebm2all::Context_Statement_PROPERTY_MEMBER_DECL_after<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Statement_METADATA_before ebm2all::Context_Statement_METADATA_before<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Statement_METADATA_after ebm2all::Context_Statement_METADATA_after<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Statement_IMPORT_MODULE_before ebm2all::Context_Statement_IMPORT_MODULE_before<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Statement_IMPORT_MODULE_after ebm2all::Context_Statement_IMPORT_MODULE_after<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Statement_EXPRESSION_before ebm2all::Context_Statement_EXPRESSION_before<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Statement_EXPRESSION_after ebm2all::Context_Statement_EXPRESSION_after<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Statement_ERROR_REPORT_before ebm2all::Context_Statement_ERROR_REPORT_before<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Statement_ERROR_REPORT_after ebm2all::Context_Statement_ERROR_REPORT_after<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Statement_LOWERED_IO_STATEMENTS_before ebm2all::Context_Statement_LOWERED_IO_STATEMENTS_before<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Statement_LOWERED_IO_STATEMENTS_after ebm2all::Context_Statement_LOWERED_IO_STATEMENTS_after<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Statement_SUB_BYTE_RANGE_before ebm2all::Context_Statement_SUB_BYTE_RANGE_before<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Statement_SUB_BYTE_RANGE_after ebm2all::Context_Statement_SUB_BYTE_RANGE_after<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Statement_INIT_CHECK_before ebm2all::Context_Statement_INIT_CHECK_before<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Statement_INIT_CHECK_after ebm2all::Context_Statement_INIT_CHECK_after<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Statement_dispatch_before ebm2all::Context_Statement_before<Result>
    #define EBM2ALL_CODEGEN_VISITOR_Statement_dispatch_after ebm2all::Visitor<ebm2all::UserHook<ebm2all::VisitorTag_Statement_after>>
    #define EBM2ALL_CODEGEN_CONTEXT_Statement_dispatch_after ebm2all::Context_Statement_after<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Block_before ebm2all::Context_Block_before<Result>
    #define EBM2ALL_CODEGEN_VISITOR_Block_after ebm2all::Visitor<ebm2all::UserHook<ebm2all::VisitorTag_Block_after>>
    #define EBM2ALL_CODEGEN_CONTEXT_Block_after ebm2all::Context_Block_after<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Expression_LITERAL_INT_before ebm2all::Context_Expression_LITERAL_INT_before<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Expression_LITERAL_INT_after ebm2all::Context_Expression_LITERAL_INT_after<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Expression_LITERAL_INT64_before ebm2all::Context_Expression_LITERAL_INT64_before<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Expression_LITERAL_INT64_after ebm2all::Context_Expression_LITERAL_INT64_after<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Expression_LITERAL_BOOL_before ebm2all::Context_Expression_LITERAL_BOOL_before<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Expression_LITERAL_BOOL_after ebm2all::Context_Expression_LITERAL_BOOL_after<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Expression_LITERAL_STRING_before ebm2all::Context_Expression_LITERAL_STRING_before<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Expression_LITERAL_STRING_after ebm2all::Context_Expression_LITERAL_STRING_after<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Expression_LITERAL_TYPE_before ebm2all::Context_Expression_LITERAL_TYPE_before<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Expression_LITERAL_TYPE_after ebm2all::Context_Expression_LITERAL_TYPE_after<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Expression_LITERAL_CHAR_before ebm2all::Context_Expression_LITERAL_CHAR_before<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Expression_LITERAL_CHAR_after ebm2all::Context_Expression_LITERAL_CHAR_after<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Expression_IDENTIFIER_before ebm2all::Context_Expression_IDENTIFIER_before<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Expression_IDENTIFIER_after ebm2all::Context_Expression_IDENTIFIER_after<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Expression_BINARY_OP_before ebm2all::Context_Expression_BINARY_OP_before<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Expression_BINARY_OP_after ebm2all::Context_Expression_BINARY_OP_after<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Expression_UNARY_OP_before ebm2all::Context_Expression_UNARY_OP_before<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Expression_UNARY_OP_after ebm2all::Context_Expression_UNARY_OP_after<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Expression_CALL_before ebm2all::Context_Expression_CALL_before<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Expression_CALL_after ebm2all::Context_Expression_CALL_after<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Expression_INDEX_ACCESS_before ebm2all::Context_Expression_INDEX_ACCESS_before<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Expression_INDEX_ACCESS_after ebm2all::Context_Expression_INDEX_ACCESS_after<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Expression_MEMBER_ACCESS_before ebm2all::Context_Expression_MEMBER_ACCESS_before<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Expression_MEMBER_ACCESS_after ebm2all::Context_Expression_MEMBER_ACCESS_after<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Expression_ENUM_MEMBER_before ebm2all::Context_Expression_ENUM_MEMBER_before<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Expression_ENUM_MEMBER_after ebm2all::Context_Expression_ENUM_MEMBER_after<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Expression_TYPE_CAST_before ebm2all::Context_Expression_TYPE_CAST_before<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Expression_TYPE_CAST_after ebm2all::Context_Expression_TYPE_CAST_after<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Expression_RANGE_before ebm2all::Context_Expression_RANGE_before<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Expression_RANGE_after ebm2all::Context_Expression_RANGE_after<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Expression_DEFAULT_VALUE_before ebm2all::Context_Expression_DEFAULT_VALUE_before<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Expression_DEFAULT_VALUE_after ebm2all::Context_Expression_DEFAULT_VALUE_after<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Expression_IS_LITTLE_ENDIAN_before ebm2all::Context_Expression_IS_LITTLE_ENDIAN_before<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Expression_IS_LITTLE_ENDIAN_after ebm2all::Context_Expression_IS_LITTLE_ENDIAN_after<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Expression_GET_STREAM_OFFSET_before ebm2all::Context_Expression_GET_STREAM_OFFSET_before<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Expression_GET_STREAM_OFFSET_after ebm2all::Context_Expression_GET_STREAM_OFFSET_after<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Expression_GET_REMAINING_BYTES_before ebm2all::Context_Expression_GET_REMAINING_BYTES_before<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Expression_GET_REMAINING_BYTES_after ebm2all::Context_Expression_GET_REMAINING_BYTES_after<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Expression_CAN_READ_STREAM_before ebm2all::Context_Expression_CAN_READ_STREAM_before<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Expression_CAN_READ_STREAM_after ebm2all::Context_Expression_CAN_READ_STREAM_after<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Expression_ARRAY_SIZE_before ebm2all::Context_Expression_ARRAY_SIZE_before<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Expression_ARRAY_SIZE_after ebm2all::Context_Expression_ARRAY_SIZE_after<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Expression_ENUM_IS_DEFINED_before ebm2all::Context_Expression_ENUM_IS_DEFINED_before<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Expression_ENUM_IS_DEFINED_after ebm2all::Context_Expression_ENUM_IS_DEFINED_after<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Expression_IS_ERROR_before ebm2all::Context_Expression_IS_ERROR_before<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Expression_IS_ERROR_after ebm2all::Context_Expression_IS_ERROR_after<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Expression_MAX_VALUE_before ebm2all::Context_Expression_MAX_VALUE_before<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Expression_MAX_VALUE_after ebm2all::Context_Expression_MAX_VALUE_after<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Expression_READ_DATA_before ebm2all::Context_Expression_READ_DATA_before<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Expression_READ_DATA_after ebm2all::Context_Expression_READ_DATA_after<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Expression_WRITE_DATA_before ebm2all::Context_Expression_WRITE_DATA_before<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Expression_WRITE_DATA_after ebm2all::Context_Expression_WRITE_DATA_after<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Expression_CONDITIONAL_STATEMENT_before ebm2all::Context_Expression_CONDITIONAL_STATEMENT_before<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Expression_CONDITIONAL_STATEMENT_after ebm2all::Context_Expression_CONDITIONAL_STATEMENT_after<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Expression_CONDITIONAL_before ebm2all::Context_Expression_CONDITIONAL_before<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Expression_CONDITIONAL_after ebm2all::Context_Expression_CONDITIONAL_after<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Expression_AVAILABLE_before ebm2all::Context_Expression_AVAILABLE_before<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Expression_AVAILABLE_after ebm2all::Context_Expression_AVAILABLE_after<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Expression_SIZEOF_before ebm2all::Context_Expression_SIZEOF_before<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Expression_SIZEOF_after ebm2all::Context_Expression_SIZEOF_after<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Expression_SUB_RANGE_INIT_before ebm2all::Context_Expression_SUB_RANGE_INIT_before<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Expression_SUB_RANGE_INIT_after ebm2all::Context_Expression_SUB_RANGE_INIT_after<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Expression_OR_COND_before ebm2all::Context_Expression_OR_COND_before<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Expression_OR_COND_after ebm2all::Context_Expression_OR_COND_after<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Expression_ADDRESS_OF_before ebm2all::Context_Expression_ADDRESS_OF_before<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Expression_ADDRESS_OF_after ebm2all::Context_Expression_ADDRESS_OF_after<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Expression_OPTIONAL_OF_before ebm2all::Context_Expression_OPTIONAL_OF_before<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Expression_OPTIONAL_OF_after ebm2all::Context_Expression_OPTIONAL_OF_after<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Expression_SETTER_STATUS_before ebm2all::Context_Expression_SETTER_STATUS_before<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Expression_SETTER_STATUS_after ebm2all::Context_Expression_SETTER_STATUS_after<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Expression_SELF_before ebm2all::Context_Expression_SELF_before<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Expression_SELF_after ebm2all::Context_Expression_SELF_after<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Expression_AS_ARG_before ebm2all::Context_Expression_AS_ARG_before<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Expression_AS_ARG_after ebm2all::Context_Expression_AS_ARG_after<Result>
    ...
    #define EBM2ALL_CODEGEN_VISITOR_Expression_dispatch_before ebm2all::Visitor<ebm2all::UserHook<ebm2all::VisitorTag_Expression_before>>
    #define EBM2ALL_CODEGEN_CONTEXT_Expression_dispatch_before ebm2all::Context_Expression_before<Result>
    #define EBM2ALL_CODEGEN_VISITOR_Expression_dispatch_after ebm2all::Visitor<ebm2all::UserHook<ebm2all::VisitorTag_Expression_after>>
    #define EBM2ALL_CODEGEN_CONTEXT_Expression_dispatch_after ebm2all::Context_Expression_after<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Expressions_before ebm2all::Context_Expressions_before<Result>
    #define EBM2ALL_CODEGEN_VISITOR_Expressions_after ebm2all::Visitor<ebm2all::UserHook<ebm2all::VisitorTag_Expressions_after>>
    #define EBM2ALL_CODEGEN_CONTEXT_Expressions_after ebm2all::Context_Expressions_after<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Type_INT_before ebm2all::Context_Type_INT_before<Result>
    #define EBM2ALL_CODEGEN_VISITOR_Type_INT_after ebm2all::Visitor<ebm2all::UserHook<ebm2all::VisitorTag_Type_INT_after>>
    #define EBM2ALL_CODEGEN_CONTEXT_Type_INT_after ebm2all::Context_Type_INT_after<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Type_UINT_before ebm2all::Context_Type_UINT_before<Result>
    #define EBM2ALL_CODEGEN_VISITOR_Type_UINT_after ebm2all::Visitor<ebm2all::UserHook<ebm2all::VisitorTag_Type_UINT_after>>
    #define EBM2ALL_CODEGEN_CONTEXT_Type_UINT_after ebm2all::Context_Type_UINT_after<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Type_USIZE_before ebm2all::Context_Type_USIZE_before<Result>
    #define EBM2ALL_CODEGEN_VISITOR_Type_USIZE_after ebm2all::Visitor<ebm2all::UserHook<ebm2all::VisitorTag_Type_USIZE_after>>
    #define EBM2ALL_CODEGEN_CONTEXT_Type_USIZE_after ebm2all::Context_Type_USIZE_after<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Type_FLOAT_before ebm2all::Context_Type_FLOAT_before<Result>
    #define EBM2ALL_CODEGEN_VISITOR_Type_FLOAT_after ebm2all::Visitor<ebm2all::UserHook<ebm2all::VisitorTag_Type_FLOAT_after>>
    #define EBM2ALL_CODEGEN_CONTEXT_Type_FLOAT_after ebm2all::Context_Type_FLOAT_after<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Type_STRUCT_before ebm2all::Context_Type_STRUCT_before<Result>
    #define EBM2ALL_CODEGEN_VISITOR_Type_STRUCT_after ebm2all::Visitor<ebm2all::UserHook<ebm2all::VisitorTag_Type_STRUCT_after>>
    #define EBM2ALL_CODEGEN_CONTEXT_Type_STRUCT_after ebm2all::Context_Type_STRUCT_after<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Type_RECURSIVE_STRUCT_before ebm2all::Context_Type_RECURSIVE_STRUCT_before<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Type_RECURSIVE_STRUCT_after ebm2all::Context_Type_RECURSIVE_STRUCT_after<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Type_BOOL_before ebm2all::Context_Type_BOOL_before<Result>
    #define EBM2ALL_CODEGEN_VISITOR_Type_BOOL_after ebm2all::Visitor<ebm2all::UserHook<ebm2all::VisitorTag_Type_BOOL_after>>
    #define EBM2ALL_CODEGEN_CONTEXT_Type_BOOL_after ebm2all::Context_Type_BOOL_after<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Type_VOID_before ebm2all::Context_Type_VOID_before<Result>
    #define EBM2ALL_CODEGEN_VISITOR_Type_VOID_after ebm2all::Visitor<ebm2all::UserHook<ebm2all::VisitorTag_Type_VOID_after>>
    #define EBM2ALL_CODEGEN_CONTEXT_Type_VOID_after ebm2all::Context_Type_VOID_after<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Type_META_before ebm2all::Context_Type_META_before<Result>
    #define EBM2ALL_CODEGEN_VISITOR_Type_META_after ebm2all::Visitor<ebm2all::UserHook<ebm2all::VisitorTag_Type_META_after>>
    #define EBM2ALL_CODEGEN_CONTEXT_Type_META_after ebm2all::Context_Type_META_after<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Type_ENUM_before ebm2all::Context_Type_ENUM_before<Result>
    #define EBM2ALL_CODEGEN_VISITOR_Type_ENUM_after ebm2all::Visitor<ebm2all::UserHook<ebm2all::VisitorTag_Type_ENUM_after>>
    #define EBM2ALL_CODEGEN_CONTEXT_Type_ENUM_after ebm2all::Context_Type_ENUM_after<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Type_ARRAY_before ebm2all::Context_Type_ARRAY_before<Result>
    #define EBM2ALL_CODEGEN_VISITOR_Type_ARRAY_after ebm2all::Visitor<ebm2all::UserHook<ebm2all::VisitorTag_Type_ARRAY_after>>
    #define EBM2ALL_CODEGEN_CONTEXT_Type_ARRAY_after ebm2all::Context_Type_ARRAY_after<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Type_VECTOR_before ebm2all::Context_Type_VECTOR_before<Result>
    #define EBM2ALL_CODEGEN_VISITOR_Type_VECTOR_after ebm2all::Visitor<ebm2all::UserHook<ebm2all::VisitorTag_Type_VECTOR_after>>
    #define EBM2ALL_CODEGEN_CONTEXT_Type_VECTOR_after ebm2all::Context_Type_VECTOR_after<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Type_VARIANT_before ebm2all::Context_Type_VARIANT_before<Result>
    #define EBM2ALL_CODEGEN_VISITOR_Type_VARIANT_after ebm2all::Visitor<ebm2all::UserHook<ebm2all::VisitorTag_Type_VARIANT_after>>
    #define EBM2ALL_CODEGEN_CONTEXT_Type_VARIANT_after ebm2all::Context_Type_VARIANT_after<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Type_RANGE_before ebm2all::Context_Type_RANGE_before<Result>
    #define EBM2ALL_CODEGEN_VISITOR_Type_RANGE_after ebm2all::Visitor<ebm2all::UserHook<ebm2all::VisitorTag_Type_RANGE_after>>
    #define EBM2ALL_CODEGEN_CONTEXT_Type_RANGE_after ebm2all::Context_Type_RANGE_after<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Type_ENCODER_RETURN_before ebm2all::Context_Type_ENCODER_RETURN_before<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Type_ENCODER_RETURN_after ebm2all::Context_Type_ENCODER_RETURN_after<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Type_DECODER_RETURN_before ebm2all::Context_Type_DECODER_RETURN_before<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Type_DECODER_RETURN_after ebm2all::Context_Type_DECODER_RETURN_after<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Type_ENCODER_INPUT_before ebm2all::Context_Type_ENCODER_INPUT_before<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Type_ENCODER_INPUT_after ebm2all::Context_Type_ENCODER_INPUT_after<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Type_DECODER_INPUT_before ebm2all::Context_Type_DECODER_INPUT_before<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Type_DECODER_INPUT_after ebm2all::Context_Type_DECODER_INPUT_after<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Type_PROPERTY_SETTER_RETURN_before ebm2all::Context_Type_PROPERTY_SETTER_RETURN_before<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Type_PROPERTY_SETTER_RETURN_after ebm2all::Context_Type_PROPERTY_SETTER_RETURN_after<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Type_OPTIONAL_before ebm2all::Context_Type_OPTIONAL_before<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Type_OPTIONAL_after ebm2all::Context_Type_OPTIONAL_after<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Type_PTR_before ebm2all::Context_Type_PTR_before<Result>
    #define EBM2ALL_CODEGEN_VISITOR_Type_PTR_after ebm2all::Visitor<ebm2all::UserHook<ebm2all::VisitorTag_Type_PTR_after>>
    #define EBM2ALL_CODEGEN_CONTEXT_Type_PTR_after ebm2all::Context_Type_PTR_after<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Type_FUNCTION_before ebm2all::Context_Type_FUNCTION_before<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Type_FUNCTION_after ebm2all::Context_Type_FUNCTION_after<Result>
    ...
    #define EBM2ALL_CODEGEN_VISITOR_Type_dispatch_before ebm2all::Visitor<ebm2all::UserHook<ebm2all::VisitorTag_Type_before>>
    #define EBM2ALL_CODEGEN_CONTEXT_Type_dispatch_before ebm2all::Context_Type_before<Result>
    #define EBM2ALL_CODEGEN_VISITOR_Type_dispatch_after ebm2all::Visitor<ebm2all::UserHook<ebm2all::VisitorTag_Type_after>>
    #define EBM2ALL_CODEGEN_CONTEXT_Type_dispatch_after ebm2all::Context_Type_after<Result>
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Types_before ebm2all::Context_Types_before<Result>
    #define EBM2ALL_CODEGEN_VISITOR_Types_after ebm2all::Visitor<ebm2all::UserHook<ebm2all::VisitorTag_Types_after>>
    #define EBM2ALL_CODEGEN_CONTEXT_Types_after ebm2all::Context_Types_after<Result>
...
#elif __has_include("src/ebmcodegen/default_interpret_visitor/visitorpost_includes_before.hpp")
#include "src/ebmcodegen/default_interpret_visitor/visitorpost_includes_before.hpp"
#endif
...
#elif __has_include("src/ebmcodegen/default_interpret_visitor/visitorpost_includes.hpp")
#include "src/ebmcodegen/default_interpret_visitor/visitorpost_includes.hpp"
#endif
...
#elif __has_include("src/ebmcodegen/default_interpret_visitor/visitorpost_includes_after.hpp")
#include "src/ebmcodegen/default_interpret_visitor/visitorpost_includes_after.hpp"
#endif
