...
with open(output, "w") as f:
    ...
    f.write("save = sp.check_output(\n")
    f.write("    [\"tool/bmgen\", \"-p\", \"-i\", \"save/sample.json\", \"-o\", \"save/save.bin\", \"-c\", \"save/save.dot\",\"--print-process-time\"],\n")
    f.write("    stderr=sys.stderr,\n")
    f.write(")\n")
    ...
    f.write("save = sp.check_output(\n")
    f.write("    [\"tool/bmgen\", \"-p\", \"-i\", \"save/sample.json\", \"--print-only-op\",\"--print-process-time\"],\n")
    f.write("    stderr=sys.stderr,\n")
    f.write(")\n")
    ...
    for file in src:
        ...
        f.write(f"    with open(\"save/{file["lang"]}/save.{file["suffix"]}\", \"rb\") as f:\n")
        f.write(f"        if f.read() == src:\n")
        f.write(f"            print(f\"Cached: save/{file["lang"]}/save.{file["suffix"]}\")\n")
