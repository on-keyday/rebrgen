...
namespace ebm2p4 {
    ...
    // Deconstruct context fields
    #define EBM2P4_DECONSTRUCT_STATEMENT_ARRAY_TO_INT(instance_name) \
    ...
    // Deconstruct context fields
    #define EBM2P4_DECONSTRUCT_STATEMENT_ARRAY_TO_INT_BEFORE(instance_name) \
    ...
    // Deconstruct context fields
    #define EBM2P4_DECONSTRUCT_STATEMENT_ARRAY_TO_INT_AFTER(instance_name) \
    ...
    // Deconstruct context fields
    #define EBM2P4_DECONSTRUCT_STATEMENT_INT_TO_ARRAY(instance_name) \
    auto& visitor = instance_name.visitor;auto& item_id = instance_name.item_id;auto& kind = instance_name.kind;auto& endian_convert = instance_name.endian_convert;
    template <typename Result>
    ...
    // Deconstruct context fields
    #define EBM2P4_DECONSTRUCT_STATEMENT_INT_TO_ARRAY_BEFORE(instance_name) \
    auto& visitor = instance_name.visitor;auto& item_id = instance_name.item_id;auto& kind = instance_name.kind;auto& endian_convert = instance_name.endian_convert;auto& main_logic = instance_name.main_logic;
    template <typename Result>
    ...
    // Deconstruct context fields
    #define EBM2P4_DECONSTRUCT_STATEMENT_INT_TO_ARRAY_AFTER(instance_name) \
    auto& visitor = instance_name.visitor;auto& item_id = instance_name.item_id;auto& kind = instance_name.kind;auto& endian_convert = instance_name.endian_convert;auto& main_logic = instance_name.main_logic;auto& result = instance_name.result;
    ...
    // Deconstruct context fields
    #define EBM2P4_DECONSTRUCT_STATEMENT_LENGTH_CHECK(instance_name) \
    ...
    // Deconstruct context fields
    #define EBM2P4_DECONSTRUCT_STATEMENT_LENGTH_CHECK_BEFORE(instance_name) \
    ...
    // Deconstruct context fields
    #define EBM2P4_DECONSTRUCT_STATEMENT_LENGTH_CHECK_AFTER(instance_name) \
    ...
    #define EBM2P4_CODEGEN_VISITOR_Statement_ARRAY_TO_INT ebm2p4::Visitor<ebm2p4::UserHook<ebm2p4::VisitorTag_Statement_ARRAY_TO_INT>>
    #define EBM2P4_CODEGEN_CONTEXT_Statement_ARRAY_TO_INT ebm2p4::Context_Statement_ARRAY_TO_INT
    #define EBM2P4_CODEGEN_VISITOR_Statement_ARRAY_TO_INT_before ebm2p4::Visitor<ebm2p4::UserHook<ebm2p4::VisitorTag_Statement_ARRAY_TO_INT_before>>
    #define EBM2P4_CODEGEN_CONTEXT_Statement_ARRAY_TO_INT_before ebm2p4::Context_Statement_ARRAY_TO_INT_before<Result>
    #define EBM2P4_CODEGEN_VISITOR_Statement_ARRAY_TO_INT_after ebm2p4::Visitor<ebm2p4::UserHook<ebm2p4::VisitorTag_Statement_ARRAY_TO_INT_after>>
    #define EBM2P4_CODEGEN_CONTEXT_Statement_ARRAY_TO_INT_after ebm2p4::Context_Statement_ARRAY_TO_INT_after<Result>
    #define EBM2P4_CODEGEN_VISITOR_Statement_INT_TO_ARRAY ebm2p4::Visitor<ebm2p4::UserHook<ebm2p4::VisitorTag_Statement_INT_TO_ARRAY>>
    #define EBM2P4_CODEGEN_CONTEXT_Statement_INT_TO_ARRAY ebm2p4::Context_Statement_INT_TO_ARRAY
    #define EBM2P4_CODEGEN_VISITOR_Statement_INT_TO_ARRAY_before ebm2p4::Visitor<ebm2p4::UserHook<ebm2p4::VisitorTag_Statement_INT_TO_ARRAY_before>>
    #define EBM2P4_CODEGEN_CONTEXT_Statement_INT_TO_ARRAY_before ebm2p4::Context_Statement_INT_TO_ARRAY_before<Result>
    #define EBM2P4_CODEGEN_VISITOR_Statement_INT_TO_ARRAY_after ebm2p4::Visitor<ebm2p4::UserHook<ebm2p4::VisitorTag_Statement_INT_TO_ARRAY_after>>
    #define EBM2P4_CODEGEN_CONTEXT_Statement_INT_TO_ARRAY_after ebm2p4::Context_Statement_INT_TO_ARRAY_after<Result>
    #define EBM2P4_CODEGEN_VISITOR_Statement_LENGTH_CHECK ebm2p4::Visitor<ebm2p4::UserHook<ebm2p4::VisitorTag_Statement_LENGTH_CHECK>>
    #define EBM2P4_CODEGEN_CONTEXT_Statement_LENGTH_CHECK ebm2p4::Context_Statement_LENGTH_CHECK
    #define EBM2P4_CODEGEN_VISITOR_Statement_LENGTH_CHECK_before ebm2p4::Visitor<ebm2p4::UserHook<ebm2p4::VisitorTag_Statement_LENGTH_CHECK_before>>
    #define EBM2P4_CODEGEN_CONTEXT_Statement_LENGTH_CHECK_before ebm2p4::Context_Statement_LENGTH_CHECK_before<Result>
    #define EBM2P4_CODEGEN_VISITOR_Statement_LENGTH_CHECK_after ebm2p4::Visitor<ebm2p4::UserHook<ebm2p4::VisitorTag_Statement_LENGTH_CHECK_after>>
    #define EBM2P4_CODEGEN_CONTEXT_Statement_LENGTH_CHECK_after ebm2p4::Context_Statement_LENGTH_CHECK_after<Result>
