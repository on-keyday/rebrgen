...
TEST(IntegrationTest, SimpleIf) {
    ...
    ASSERT_EQ(program->body.kind, ebm::StatementKind::PROGRAM_DECL);
    ...
    ASSERT_EQ(struct_decl_stmt->body.kind, ebm::StatementKind::STRUCT_DECL);
    ...
    ASSERT_EQ(if_stmt->body.kind, ebm::StatementKind::IF_STATEMENT);
    ...
    ASSERT_EQ(cond->body.kind, ebm::ExpressionKind::LITERAL_BOOL) << "Condition expression is not a boolean literal";
    ...
    ASSERT_EQ(then_block->body.kind, ebm::StatementKind::BLOCK) << "Then block is not a BLOCK statement";
    ...
    ASSERT_EQ(field_stmt->body.kind, ebm::StatementKind::FIELD_DECL) << "Field statement is not a FIELD_DECL";
