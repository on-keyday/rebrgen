...
namespace ebm {
    ...
    const ExpressionRef* SubByteRange::expression() const {
        ...
        if(!std::holds_alternative<union_struct_50>(union_variant_47)) {
            return nullptr;
        }
        return std::addressof(std::get<3>((*this).union_variant_47).expression);
        }
        return nullptr;
    }
    ...
    bool SubByteRange::expression(const ExpressionRef& v) {
        ...
        if (SubByteRangeType::expression==(*this).range_type) {
            if(!std::holds_alternative<union_struct_50>(union_variant_47)) {
                union_variant_47 = union_struct_50();
            }
            std::get<3>((*this).union_variant_47).expression = v;
            return true;
        }
        return false;
    }
    bool SubByteRange::expression(ExpressionRef&& v) {
        ...
        if (SubByteRangeType::expression==(*this).range_type) {
            ...
            std::get<3>((*this).union_variant_47).expression = std::move(v);
            return true;
        }
        return false;
    }
    const ExpressionRef* SubByteRange::length() const {
        ...
        return std::addressof(std::get<1>((*this).union_variant_47).length);
        }
        if (SubByteRangeType::seek_bytes==(*this).range_type) {
        if(!std::holds_alternative<union_struct_49>(union_variant_47)) {
            return nullptr;
        }
        return std::addressof(std::get<2>((*this).union_variant_47).length);
        }
        return nullptr;
    }
    ...
    bool SubByteRange::length(const ExpressionRef& v) {
        if (SubByteRangeType::bytes==(*this).range_type) {
            ...
            std::get<1>((*this).union_variant_47).length = v;
            return true;
        }
        if (SubByteRangeType::seek_bytes==(*this).range_type) {
            if(!std::holds_alternative<union_struct_49>(union_variant_47)) {
                union_variant_47 = union_struct_49();
            }
            std::get<2>((*this).union_variant_47).length = v;
            return true;
        }
        return false;
    }
    bool SubByteRange::length(ExpressionRef&& v) {
        if (SubByteRangeType::bytes==(*this).range_type) {
            ...
            std::get<1>((*this).union_variant_47).length = std::move(v);
            return true;
        }
        if (SubByteRangeType::seek_bytes==(*this).range_type) {
            if(!std::holds_alternative<union_struct_49>(union_variant_47)) {
            ...
            std::get<2>((*this).union_variant_47).length = std::move(v);
            return true;
        }
        return false;
    }
    const ExpressionRef* SubByteRange::offset() const {
        ...
        return std::addressof(std::get<2>((*this).union_variant_47).offset);
        }
        return nullptr;
    }
    ...
    bool SubByteRange::offset(const ExpressionRef& v) {
        ...
        if (SubByteRangeType::seek_bytes==(*this).range_type) {
            ...
            std::get<2>((*this).union_variant_47).offset = v;
            return true;
        }
        return false;
    }
    bool SubByteRange::offset(ExpressionRef&& v) {
        ...
        if (SubByteRangeType::seek_bytes==(*this).range_type) {
            ...
            std::get<2>((*this).union_variant_47).offset = std::move(v);
            return true;
        }
        return false;
    }
    const ExpressionRef* LoopStatement::collection() const {
        ...
        if(!std::holds_alternative<union_struct_55>(union_variant_52)) {
            return nullptr;
        }
        return std::addressof(std::get<3>((*this).union_variant_52).collection);
        }
        return nullptr;
    }
    ...
    bool LoopStatement::collection(const ExpressionRef& v) {
        ...
        if (LoopType::FOR_EACH==(*this).loop_type) {
            if(!std::holds_alternative<union_struct_55>(union_variant_52)) {
                union_variant_52 = union_struct_55();
            }
            std::get<3>((*this).union_variant_52).collection = v;
            return true;
        }
        return false;
    }
    bool LoopStatement::collection(ExpressionRef&& v) {
        ...
        if (LoopType::FOR_EACH==(*this).loop_type) {
            ...
            std::get<3>((*this).union_variant_52).collection = std::move(v);
            return true;
        }
        return false;
    }
    const Condition* LoopStatement::condition() const {
        ...
        if (LoopType::WHILE==(*this).loop_type) {
        if(!std::holds_alternative<union_struct_54>(union_variant_52)) {
            return nullptr;
        }
        return std::addressof(std::get<2>((*this).union_variant_52).condition);
        }
        if (LoopType::FOR_EACH==(*this).loop_type) {
        return nullptr;
        }
        if (LoopType::FOR==(*this).loop_type) {
        if(!std::holds_alternative<union_struct_56>(union_variant_52)) {
            return nullptr;
        }
        return std::addressof(std::get<4>((*this).union_variant_52).condition);
        }
        return nullptr;
    }
    ...
    bool LoopStatement::condition(const Condition& v) {
        ...
        if (LoopType::WHILE==(*this).loop_type) {
            if(!std::holds_alternative<union_struct_54>(union_variant_52)) {
                union_variant_52 = union_struct_54();
            }
            std::get<2>((*this).union_variant_52).condition = v;
            return true;
        }
        if (LoopType::FOR_EACH==(*this).loop_type) {
            return false;
        ...
        if (LoopType::FOR==(*this).loop_type) {
            if(!std::holds_alternative<union_struct_56>(union_variant_52)) {
                union_variant_52 = union_struct_56();
            }
            std::get<4>((*this).union_variant_52).condition = v;
            return true;
        }
        return false;
    }
    bool LoopStatement::condition(Condition&& v) {
        ...
        if (LoopType::WHILE==(*this).loop_type) {
            ...
            std::get<2>((*this).union_variant_52).condition = std::move(v);
            return true;
        }
        if (LoopType::FOR_EACH==(*this).loop_type) {
            return false;
        ...
        if (LoopType::FOR==(*this).loop_type) {
            ...
            std::get<4>((*this).union_variant_52).condition = std::move(v);
            return true;
        }
        return false;
    }
    const StatementRef* LoopStatement::increment() const {
        ...
        return std::addressof(std::get<4>((*this).union_variant_52).increment);
        }
        return nullptr;
    }
    ...
    bool LoopStatement::increment(const StatementRef& v) {
        ...
        if (LoopType::FOR==(*this).loop_type) {
            ...
            std::get<4>((*this).union_variant_52).increment = v;
            return true;
        }
        return false;
    }
    bool LoopStatement::increment(StatementRef&& v) {
        ...
        if (LoopType::FOR==(*this).loop_type) {
            ...
            std::get<4>((*this).union_variant_52).increment = std::move(v);
            return true;
        }
        return false;
    }
    const StatementRef* LoopStatement::init() const {
        ...
        return std::addressof(std::get<4>((*this).union_variant_52).init);
        }
        return nullptr;
    }
    ...
    bool LoopStatement::init(const StatementRef& v) {
        ...
        if (LoopType::FOR==(*this).loop_type) {
            ...
            std::get<4>((*this).union_variant_52).init = v;
            return true;
        }
        return false;
    }
    bool LoopStatement::init(StatementRef&& v) {
        ...
        if (LoopType::FOR==(*this).loop_type) {
            ...
            std::get<4>((*this).union_variant_52).init = std::move(v);
            return true;
        }
        return false;
    }
    const StatementRef* LoopStatement::item_var() const {
        ...
        return std::addressof(std::get<3>((*this).union_variant_52).item_var);
        }
        return nullptr;
    }
    ...
    bool LoopStatement::item_var(const StatementRef& v) {
        ...
        if (LoopType::FOR_EACH==(*this).loop_type) {
            ...
            std::get<3>((*this).union_variant_52).item_var = v;
            return true;
        }
        return false;
    }
    bool LoopStatement::item_var(StatementRef&& v) {
        ...
        if (LoopType::FOR_EACH==(*this).loop_type) {
            ...
            std::get<3>((*this).union_variant_52).item_var = std::move(v);
            return true;
        }
        return false;
    }
    const ExpressionRef* PropertyDecl::cond() const {
        ...
        return std::addressof(std::get<1>((*this).union_variant_62).cond);
        }
        return nullptr;
    }
    ...
    bool PropertyDecl::cond(const ExpressionRef& v) {
        if (((*this).merge_mode == MergeMode::STRICT_TYPE)==true) {
            ...
            std::get<1>((*this).union_variant_62).cond = v;
            return true;
        }
        return false;
    }
    bool PropertyDecl::cond(ExpressionRef&& v) {
        if (((*this).merge_mode == MergeMode::STRICT_TYPE)==true) {
            ...
            std::get<1>((*this).union_variant_62).cond = std::move(v);
            return true;
        }
        return false;
    }
    const IdentifierRef* StatementBody::alias() const {
        ...
        if(!std::holds_alternative<union_struct_93>(union_variant_65)) {
            return nullptr;
        }
        return std::addressof(std::get<28>((*this).union_variant_65).alias);
        }
        return nullptr;
    }
    ...
    bool StatementBody::alias(const IdentifierRef& v) {
        ...
        if (StatementKind::IMPORT_MODULE==(*this).kind) {
            if(!std::holds_alternative<union_struct_93>(union_variant_65)) {
                union_variant_65 = union_struct_93();
            }
            std::get<28>((*this).union_variant_65).alias = v;
            return true;
        }
        return false;
    }
    bool StatementBody::alias(IdentifierRef&& v) {
        ...
        if (StatementKind::IMPORT_MODULE==(*this).kind) {
            ...
            std::get<28>((*this).union_variant_65).alias = std::move(v);
            return true;
        }
        return false;
    }
    const AssertDesc* StatementBody::assert_desc() const {
        ...
        if (StatementKind::ASSERT==(*this).kind) {
        if(!std::holds_alternative<union_struct_72>(union_variant_65)) {
            return nullptr;
        }
        return std::addressof(std::get<7>((*this).union_variant_65).assert_desc);
        }
        return nullptr;
    }
    ...
    bool StatementBody::assert_desc(const AssertDesc& v) {
        ...
        if (StatementKind::ASSERT==(*this).kind) {
            if(!std::holds_alternative<union_struct_72>(union_variant_65)) {
                union_variant_65 = union_struct_72();
            }
            std::get<7>((*this).union_variant_65).assert_desc = v;
            return true;
        }
        return false;
    }
    bool StatementBody::assert_desc(AssertDesc&& v) {
        ...
        if (StatementKind::ASSERT==(*this).kind) {
            ...
            std::get<7>((*this).union_variant_65).assert_desc = std::move(v);
            return true;
        }
        return false;
    }
    const Block* StatementBody::block() const {
        ...
        return std::addressof(std::get<1>((*this).union_variant_65).block);
        }
        if (StatementKind::ASSIGNMENT==(*this).kind) {
        return nullptr;
        }
        ...
        if (StatementKind::PROGRAM_DECL==(*this).kind) {
        if(!std::holds_alternative<union_struct_89>(union_variant_65)) {
            return nullptr;
        }
        return std::addressof(std::get<24>((*this).union_variant_65).block);
        }
        return nullptr;
    }
    ...
    bool StatementBody::block(const Block& v) {
        if (StatementKind::BLOCK==(*this).kind) {
            ...
            std::get<1>((*this).union_variant_65).block = v;
            return true;
        }
        if (StatementKind::ASSIGNMENT==(*this).kind) {
            return false;
        ...
        if (StatementKind::PROGRAM_DECL==(*this).kind) {
            if(!std::holds_alternative<union_struct_89>(union_variant_65)) {
                union_variant_65 = union_struct_89();
            }
            std::get<24>((*this).union_variant_65).block = v;
            return true;
        }
        return false;
    }
    bool StatementBody::block(Block&& v) {
        if (StatementKind::BLOCK==(*this).kind) {
            ...
            std::get<1>((*this).union_variant_65).block = std::move(v);
            return true;
        }
        if (StatementKind::ASSIGNMENT==(*this).kind) {
            return false;
        ...
        if (StatementKind::PROGRAM_DECL==(*this).kind) {
            ...
            std::get<24>((*this).union_variant_65).block = std::move(v);
            return true;
        }
        return false;
    }
    const LoopFlowControl* StatementBody::break_() const {
        ...
        if (StatementKind::BREAK==(*this).kind) {
        if(!std::holds_alternative<union_struct_80>(union_variant_65)) {
            return nullptr;
        }
        return std::addressof(std::get<15>((*this).union_variant_65).break_);
        }
        return nullptr;
    }
    ...
    bool StatementBody::break_(const LoopFlowControl& v) {
        ...
        if (StatementKind::BREAK==(*this).kind) {
            if(!std::holds_alternative<union_struct_80>(union_variant_65)) {
                union_variant_65 = union_struct_80();
            }
            std::get<15>((*this).union_variant_65).break_ = v;
            return true;
        }
        return false;
    }
    bool StatementBody::break_(LoopFlowControl&& v) {
        ...
        if (StatementKind::BREAK==(*this).kind) {
            ...
            std::get<15>((*this).union_variant_65).break_ = std::move(v);
            return true;
        }
        return false;
    }
    const LoopFlowControl* StatementBody::continue_() const {
        ...
        if (StatementKind::CONTINUE==(*this).kind) {
        if(!std::holds_alternative<union_struct_81>(union_variant_65)) {
            return nullptr;
        }
        return std::addressof(std::get<16>((*this).union_variant_65).continue_);
        }
        return nullptr;
    }
    ...
    bool StatementBody::continue_(const LoopFlowControl& v) {
        ...
        if (StatementKind::CONTINUE==(*this).kind) {
            if(!std::holds_alternative<union_struct_81>(union_variant_65)) {
                union_variant_65 = union_struct_81();
            }
            std::get<16>((*this).union_variant_65).continue_ = v;
            return true;
        }
        return false;
    }
    bool StatementBody::continue_(LoopFlowControl&& v) {
        ...
        if (StatementKind::CONTINUE==(*this).kind) {
            ...
            std::get<16>((*this).union_variant_65).continue_ = std::move(v);
            return true;
        }
        return false;
    }
    const EnumDecl* StatementBody::enum_decl() const {
        ...
        if (StatementKind::ENUM_DECL==(*this).kind) {
        if(!std::holds_alternative<union_struct_86>(union_variant_65)) {
            return nullptr;
        }
        return std::addressof(std::get<21>((*this).union_variant_65).enum_decl);
        }
        return nullptr;
    }
    ...
    bool StatementBody::enum_decl(const EnumDecl& v) {
        ...
        if (StatementKind::ENUM_DECL==(*this).kind) {
            if(!std::holds_alternative<union_struct_86>(union_variant_65)) {
                union_variant_65 = union_struct_86();
            }
            std::get<21>((*this).union_variant_65).enum_decl = v;
            return true;
        }
        return false;
    }
    bool StatementBody::enum_decl(EnumDecl&& v) {
        ...
        if (StatementKind::ENUM_DECL==(*this).kind) {
            ...
            std::get<21>((*this).union_variant_65).enum_decl = std::move(v);
            return true;
        }
        return false;
    }
    const EnumMemberDecl* StatementBody::enum_member_decl() const {
        ...
        if (StatementKind::ENUM_MEMBER_DECL==(*this).kind) {
        if(!std::holds_alternative<union_struct_87>(union_variant_65)) {
            return nullptr;
        }
        return std::addressof(std::get<22>((*this).union_variant_65).enum_member_decl);
        }
        return nullptr;
    }
    ...
    bool StatementBody::enum_member_decl(const EnumMemberDecl& v) {
        ...
        if (StatementKind::ENUM_MEMBER_DECL==(*this).kind) {
            if(!std::holds_alternative<union_struct_87>(union_variant_65)) {
                union_variant_65 = union_struct_87();
            }
            std::get<22>((*this).union_variant_65).enum_member_decl = v;
            return true;
        }
        return false;
    }
    bool StatementBody::enum_member_decl(EnumMemberDecl&& v) {
        ...
        if (StatementKind::ENUM_MEMBER_DECL==(*this).kind) {
            ...
            std::get<22>((*this).union_variant_65).enum_member_decl = std::move(v);
            return true;
        }
        return false;
    }
    const ErrorReport* StatementBody::error_report() const {
        ...
        if(!std::holds_alternative<union_struct_94>(union_variant_65)) {
            return nullptr;
        }
        return std::addressof(std::get<29>((*this).union_variant_65).error_report);
        }
        return nullptr;
    }
    ...
    bool StatementBody::error_report(const ErrorReport& v) {
        ...
        if (StatementKind::ERROR_REPORT==(*this).kind) {
            if(!std::holds_alternative<union_struct_94>(union_variant_65)) {
                union_variant_65 = union_struct_94();
            }
            std::get<29>((*this).union_variant_65).error_report = v;
            return true;
        }
        return false;
    }
    bool StatementBody::error_report(ErrorReport&& v) {
        ...
        if (StatementKind::ERROR_REPORT==(*this).kind) {
            ...
            std::get<29>((*this).union_variant_65).error_report = std::move(v);
            return true;
        }
        return false;
    }
    const ExpressionRef* StatementBody::expression() const {
        ...
        if(!std::holds_alternative<union_struct_95>(union_variant_65)) {
            return nullptr;
        }
        return std::addressof(std::get<30>((*this).union_variant_65).expression);
        }
        return nullptr;
    }
    ...
    bool StatementBody::expression(const ExpressionRef& v) {
        ...
        if (StatementKind::EXPRESSION==(*this).kind) {
            if(!std::holds_alternative<union_struct_95>(union_variant_65)) {
                union_variant_65 = union_struct_95();
            }
            std::get<30>((*this).union_variant_65).expression = v;
            return true;
        }
        return false;
    }
    bool StatementBody::expression(ExpressionRef&& v) {
        ...
        if (StatementKind::EXPRESSION==(*this).kind) {
            ...
            std::get<30>((*this).union_variant_65).expression = std::move(v);
            return true;
        }
        return false;
    }
    const FieldDecl* StatementBody::field_decl() const {
        ...
        if (StatementKind::FIELD_DECL==(*this).kind) {
        if(!std::holds_alternative<union_struct_85>(union_variant_65)) {
            return nullptr;
        }
        return std::addressof(std::get<20>((*this).union_variant_65).field_decl);
        }
        return nullptr;
    }
    ...
    bool StatementBody::field_decl(const FieldDecl& v) {
        ...
        if (StatementKind::FIELD_DECL==(*this).kind) {
            if(!std::holds_alternative<union_struct_85>(union_variant_65)) {
                union_variant_65 = union_struct_85();
            }
            std::get<20>((*this).union_variant_65).field_decl = v;
            return true;
        }
        return false;
    }
    bool StatementBody::field_decl(FieldDecl&& v) {
        ...
        if (StatementKind::FIELD_DECL==(*this).kind) {
            ...
            std::get<20>((*this).union_variant_65).field_decl = std::move(v);
            return true;
        }
        return false;
    }
    const FunctionDecl* StatementBody::func_decl() const {
        ...
        if (StatementKind::FUNCTION_DECL==(*this).kind) {
        if(!std::holds_alternative<union_struct_82>(union_variant_65)) {
            return nullptr;
        }
        return std::addressof(std::get<17>((*this).union_variant_65).func_decl);
        }
        return nullptr;
    }
    ...
    bool StatementBody::func_decl(const FunctionDecl& v) {
        ...
        if (StatementKind::FUNCTION_DECL==(*this).kind) {
            if(!std::holds_alternative<union_struct_82>(union_variant_65)) {
                union_variant_65 = union_struct_82();
            }
            std::get<17>((*this).union_variant_65).func_decl = v;
            return true;
        }
        return false;
    }
    bool StatementBody::func_decl(FunctionDecl&& v) {
        ...
        if (StatementKind::FUNCTION_DECL==(*this).kind) {
            ...
            std::get<17>((*this).union_variant_65).func_decl = std::move(v);
            return true;
        }
        return false;
    }
    const IfStatement* StatementBody::if_statement() const {
        ...
        return std::addressof(std::get<11>((*this).union_variant_65).if_statement);
        }
        return nullptr;
    }
    ...
    bool StatementBody::if_statement(const IfStatement& v) {
        ...
        if (StatementKind::IF_STATEMENT==(*this).kind) {
            if(!std::holds_alternative<union_struct_76>(union_variant_65)) {
                union_variant_65 = union_struct_76();
            }
            std::get<11>((*this).union_variant_65).if_statement = v;
            return true;
        }
        return false;
    }
    bool StatementBody::if_statement(IfStatement&& v) {
        ...
        if (StatementKind::IF_STATEMENT==(*this).kind) {
            ...
            std::get<11>((*this).union_variant_65).if_statement = std::move(v);
            return true;
        }
        return false;
    }
    const InitCheck* StatementBody::init_check() const {
        ...
        if(!std::holds_alternative<union_struct_98>(union_variant_65)) {
            return nullptr;
        }
        return std::addressof(std::get<33>((*this).union_variant_65).init_check);
        }
        return nullptr;
    }
    ...
    bool StatementBody::init_check(const InitCheck& v) {
        ...
        if (StatementKind::INIT_CHECK==(*this).kind) {
            if(!std::holds_alternative<union_struct_98>(union_variant_65)) {
                union_variant_65 = union_struct_98();
            }
            std::get<33>((*this).union_variant_65).init_check = v;
            return true;
        }
        return false;
    }
    bool StatementBody::init_check(InitCheck&& v) {
        ...
        if (StatementKind::INIT_CHECK==(*this).kind) {
            ...
            std::get<33>((*this).union_variant_65).init_check = std::move(v);
            return true;
        }
        return false;
    }
    const LoopStatement* StatementBody::loop() const {
        ...
        if (StatementKind::LOOP_STATEMENT==(*this).kind) {
        if(!std::holds_alternative<union_struct_77>(union_variant_65)) {
            return nullptr;
        }
        return std::addressof(std::get<12>((*this).union_variant_65).loop);
        }
        return nullptr;
    }
    ...
    bool StatementBody::loop(const LoopStatement& v) {
        ...
        if (StatementKind::LOOP_STATEMENT==(*this).kind) {
            if(!std::holds_alternative<union_struct_77>(union_variant_65)) {
                union_variant_65 = union_struct_77();
            }
            std::get<12>((*this).union_variant_65).loop = v;
            return true;
        }
        return false;
    }
    bool StatementBody::loop(LoopStatement&& v) {
        ...
        if (StatementKind::LOOP_STATEMENT==(*this).kind) {
            ...
            std::get<12>((*this).union_variant_65).loop = std::move(v);
            return true;
        }
        return false;
    }
    const LoweredStatements* StatementBody::lowered_statements() const {
        ...
        if (StatementKind::LOWERED_STATEMENTS==(*this).kind) {
        if(!std::holds_alternative<union_struct_96>(union_variant_65)) {
            return nullptr;
        }
        return std::addressof(std::get<31>((*this).union_variant_65).lowered_statements);
        }
        return nullptr;
    }
    ...
    bool StatementBody::lowered_statements(const LoweredStatements& v) {
        ...
        if (StatementKind::LOWERED_STATEMENTS==(*this).kind) {
            if(!std::holds_alternative<union_struct_96>(union_variant_65)) {
                union_variant_65 = union_struct_96();
            }
            std::get<31>((*this).union_variant_65).lowered_statements = v;
            return true;
        }
        return false;
    }
    bool StatementBody::lowered_statements(LoweredStatements&& v) {
        ...
        if (StatementKind::LOWERED_STATEMENTS==(*this).kind) {
            ...
            std::get<31>((*this).union_variant_65).lowered_statements = std::move(v);
            return true;
        }
        return false;
    }
    const MatchBranch* StatementBody::match_branch() const {
        ...
        if (StatementKind::MATCH_BRANCH==(*this).kind) {
        if(!std::holds_alternative<union_struct_79>(union_variant_65)) {
            return nullptr;
        }
        return std::addressof(std::get<14>((*this).union_variant_65).match_branch);
        }
        return nullptr;
    }
    ...
    bool StatementBody::match_branch(const MatchBranch& v) {
        ...
        if (StatementKind::MATCH_BRANCH==(*this).kind) {
            if(!std::holds_alternative<union_struct_79>(union_variant_65)) {
                union_variant_65 = union_struct_79();
            }
            std::get<14>((*this).union_variant_65).match_branch = v;
            return true;
        }
        return false;
    }
    bool StatementBody::match_branch(MatchBranch&& v) {
        ...
        if (StatementKind::MATCH_BRANCH==(*this).kind) {
            ...
            std::get<14>((*this).union_variant_65).match_branch = std::move(v);
            return true;
        }
        return false;
    }
    const MatchStatement* StatementBody::match_statement() const {
        ...
        if (StatementKind::MATCH_STATEMENT==(*this).kind) {
        if(!std::holds_alternative<union_struct_78>(union_variant_65)) {
            return nullptr;
        }
        return std::addressof(std::get<13>((*this).union_variant_65).match_statement);
        }
        return nullptr;
    }
    ...
    bool StatementBody::match_statement(const MatchStatement& v) {
        ...
        if (StatementKind::MATCH_STATEMENT==(*this).kind) {
            if(!std::holds_alternative<union_struct_78>(union_variant_65)) {
                union_variant_65 = union_struct_78();
            }
            std::get<13>((*this).union_variant_65).match_statement = v;
            return true;
        }
        return false;
    }
    bool StatementBody::match_statement(MatchStatement&& v) {
        ...
        if (StatementKind::MATCH_STATEMENT==(*this).kind) {
            ...
            std::get<13>((*this).union_variant_65).match_statement = std::move(v);
            return true;
        }
        return false;
    }
    const Metadata* StatementBody::metadata() const {
        ...
        if (StatementKind::METADATA==(*this).kind) {
        if(!std::holds_alternative<union_struct_92>(union_variant_65)) {
            return nullptr;
        }
        return std::addressof(std::get<27>((*this).union_variant_65).metadata);
        }
        return nullptr;
    }
    ...
    bool StatementBody::metadata(const Metadata& v) {
        ...
        if (StatementKind::METADATA==(*this).kind) {
            if(!std::holds_alternative<union_struct_92>(union_variant_65)) {
                union_variant_65 = union_struct_92();
            }
            std::get<27>((*this).union_variant_65).metadata = v;
            return true;
        }
        return false;
    }
    bool StatementBody::metadata(Metadata&& v) {
        ...
        if (StatementKind::METADATA==(*this).kind) {
            ...
            std::get<27>((*this).union_variant_65).metadata = std::move(v);
            return true;
        }
        return false;
    }
    const IdentifierRef* StatementBody::module_name() const {
        ...
        return std::addressof(std::get<28>((*this).union_variant_65).module_name);
        }
        return nullptr;
    }
    ...
    bool StatementBody::module_name(const IdentifierRef& v) {
        ...
        if (StatementKind::IMPORT_MODULE==(*this).kind) {
            ...
            std::get<28>((*this).union_variant_65).module_name = v;
            return true;
        }
        return false;
    }
    bool StatementBody::module_name(IdentifierRef&& v) {
        ...
        if (StatementKind::IMPORT_MODULE==(*this).kind) {
            ...
            std::get<28>((*this).union_variant_65).module_name = std::move(v);
            return true;
        }
        return false;
    }
    const ExpressionRef* StatementBody::offset() const {
        ...
        if (StatementKind::SEEK_STREAM==(*this).kind) {
        if(!std::holds_alternative<union_struct_75>(union_variant_65)) {
            return nullptr;
        }
        return std::addressof(std::get<10>((*this).union_variant_65).offset);
        }
        return nullptr;
    }
    ...
    bool StatementBody::offset(const ExpressionRef& v) {
        ...
        if (StatementKind::SEEK_STREAM==(*this).kind) {
            if(!std::holds_alternative<union_struct_75>(union_variant_65)) {
                union_variant_65 = union_struct_75();
            }
            std::get<10>((*this).union_variant_65).offset = v;
            return true;
        }
        return false;
    }
    bool StatementBody::offset(ExpressionRef&& v) {
        ...
        if (StatementKind::SEEK_STREAM==(*this).kind) {
            ...
            std::get<10>((*this).union_variant_65).offset = std::move(v);
            return true;
        }
        return false;
    }
    const ParameterDecl* StatementBody::param_decl() const {
        ...
        if (StatementKind::PARAMETER_DECL==(*this).kind) {
        if(!std::holds_alternative<union_struct_84>(union_variant_65)) {
            return nullptr;
        }
        return std::addressof(std::get<19>((*this).union_variant_65).param_decl);
        }
        return nullptr;
    }
    ...
    bool StatementBody::param_decl(const ParameterDecl& v) {
        ...
        if (StatementKind::PARAMETER_DECL==(*this).kind) {
            if(!std::holds_alternative<union_struct_84>(union_variant_65)) {
                union_variant_65 = union_struct_84();
            }
            std::get<19>((*this).union_variant_65).param_decl = v;
            return true;
        }
        return false;
    }
    bool StatementBody::param_decl(ParameterDecl&& v) {
        ...
        if (StatementKind::PARAMETER_DECL==(*this).kind) {
            ...
            std::get<19>((*this).union_variant_65).param_decl = std::move(v);
            return true;
        }
        return false;
    }
    const StatementRef* StatementBody::previous_assignment() const {
        ...
        return std::addressof(std::get<2>((*this).union_variant_65).previous_assignment);
        }
        if (StatementKind::YIELD==(*this).kind) {
        if(!std::holds_alternative<union_struct_68>(union_variant_65)) {
            return nullptr;
        }
        return std::addressof(std::get<3>((*this).union_variant_65).previous_assignment);
        }
        return nullptr;
    }
    ...
    bool StatementBody::previous_assignment(const StatementRef& v) {
        ...
        if (StatementKind::ASSIGNMENT==(*this).kind) {
            ...
            std::get<2>((*this).union_variant_65).previous_assignment = v;
            return true;
        }
        if (StatementKind::YIELD==(*this).kind) {
            if(!std::holds_alternative<union_struct_68>(union_variant_65)) {
            ...
            std::get<3>((*this).union_variant_65).previous_assignment = v;
            return true;
        }
        return false;
    }
    bool StatementBody::previous_assignment(StatementRef&& v) {
        ...
        if (StatementKind::ASSIGNMENT==(*this).kind) {
            ...
            std::get<2>((*this).union_variant_65).previous_assignment = std::move(v);
            return true;
        }
        if (StatementKind::YIELD==(*this).kind) {
            if(!std::holds_alternative<union_struct_68>(union_variant_65)) {
            ...
            std::get<3>((*this).union_variant_65).previous_assignment = std::move(v);
            return true;
        }
        return false;
    }
    const PropertyDecl* StatementBody::property_decl() const {
        ...
        if (StatementKind::PROPERTY_DECL==(*this).kind) {
        if(!std::holds_alternative<union_struct_90>(union_variant_65)) {
            return nullptr;
        }
        return std::addressof(std::get<25>((*this).union_variant_65).property_decl);
        }
        return nullptr;
    }
    ...
    bool StatementBody::property_decl(const PropertyDecl& v) {
        ...
        if (StatementKind::PROPERTY_DECL==(*this).kind) {
            if(!std::holds_alternative<union_struct_90>(union_variant_65)) {
                union_variant_65 = union_struct_90();
            }
            std::get<25>((*this).union_variant_65).property_decl = v;
            return true;
        }
        return false;
    }
    bool StatementBody::property_decl(PropertyDecl&& v) {
        ...
        if (StatementKind::PROPERTY_DECL==(*this).kind) {
            ...
            std::get<25>((*this).union_variant_65).property_decl = std::move(v);
            return true;
        }
        return false;
    }
    const PropertyMemberDecl* StatementBody::property_member_decl() const {
        ...
        if (StatementKind::PROPERTY_MEMBER_DECL==(*this).kind) {
        if(!std::holds_alternative<union_struct_91>(union_variant_65)) {
            return nullptr;
        }
        return std::addressof(std::get<26>((*this).union_variant_65).property_member_decl);
        }
        return nullptr;
    }
    ...
    bool StatementBody::property_member_decl(const PropertyMemberDecl& v) {
        ...
        if (StatementKind::PROPERTY_MEMBER_DECL==(*this).kind) {
            if(!std::holds_alternative<union_struct_91>(union_variant_65)) {
                union_variant_65 = union_struct_91();
            }
            std::get<26>((*this).union_variant_65).property_member_decl = v;
            return true;
        }
        return false;
    }
    bool StatementBody::property_member_decl(PropertyMemberDecl&& v) {
        ...
        if (StatementKind::PROPERTY_MEMBER_DECL==(*this).kind) {
            ...
            std::get<26>((*this).union_variant_65).property_member_decl = std::move(v);
            return true;
        }
        return false;
    }
    const IOData* StatementBody::read_data() const {
        ...
        if (StatementKind::READ_DATA==(*this).kind) {
        if(!std::holds_alternative<union_struct_73>(union_variant_65)) {
            return nullptr;
        }
        return std::addressof(std::get<8>((*this).union_variant_65).read_data);
        }
        return nullptr;
    }
    ...
    bool StatementBody::read_data(const IOData& v) {
        ...
        if (StatementKind::READ_DATA==(*this).kind) {
            if(!std::holds_alternative<union_struct_73>(union_variant_65)) {
                union_variant_65 = union_struct_73();
            }
            std::get<8>((*this).union_variant_65).read_data = v;
            return true;
        }
        return false;
    }
    bool StatementBody::read_data(IOData&& v) {
        ...
        if (StatementKind::READ_DATA==(*this).kind) {
            ...
            std::get<8>((*this).union_variant_65).read_data = std::move(v);
            return true;
        }
        return false;
    }
    const StreamType* StatementBody::stream_type() const {
        ...
        return std::addressof(std::get<10>((*this).union_variant_65).stream_type);
        }
        return nullptr;
    }
    ...
    bool StatementBody::stream_type(const StreamType& v) {
        ...
        if (StatementKind::SEEK_STREAM==(*this).kind) {
            ...
            std::get<10>((*this).union_variant_65).stream_type = v;
            return true;
        }
        return false;
    }
    bool StatementBody::stream_type(StreamType&& v) {
        ...
        if (StatementKind::SEEK_STREAM==(*this).kind) {
            ...
            std::get<10>((*this).union_variant_65).stream_type = std::move(v);
            return true;
        }
        return false;
    }
    const StructDecl* StatementBody::struct_decl() const {
        ...
        if (StatementKind::STRUCT_DECL==(*this).kind) {
        if(!std::holds_alternative<union_struct_88>(union_variant_65)) {
            return nullptr;
        }
        return std::addressof(std::get<23>((*this).union_variant_65).struct_decl);
        }
        return nullptr;
    }
    ...
    bool StatementBody::struct_decl(const StructDecl& v) {
        ...
        if (StatementKind::STRUCT_DECL==(*this).kind) {
            if(!std::holds_alternative<union_struct_88>(union_variant_65)) {
                union_variant_65 = union_struct_88();
            }
            std::get<23>((*this).union_variant_65).struct_decl = v;
            return true;
        }
        return false;
    }
    bool StatementBody::struct_decl(StructDecl&& v) {
        ...
        if (StatementKind::STRUCT_DECL==(*this).kind) {
            ...
            std::get<23>((*this).union_variant_65).struct_decl = std::move(v);
            return true;
        }
        return false;
    }
    const SubByteRange* StatementBody::sub_byte_range() const {
        ...
        if (StatementKind::SUB_BYTE_RANGE==(*this).kind) {
        if(!std::holds_alternative<union_struct_97>(union_variant_65)) {
            return nullptr;
        }
        return std::addressof(std::get<32>((*this).union_variant_65).sub_byte_range);
        }
        return nullptr;
    }
    ...
    bool StatementBody::sub_byte_range(const SubByteRange& v) {
        ...
        if (StatementKind::SUB_BYTE_RANGE==(*this).kind) {
            if(!std::holds_alternative<union_struct_97>(union_variant_65)) {
                union_variant_65 = union_struct_97();
            }
            std::get<32>((*this).union_variant_65).sub_byte_range = v;
            return true;
        }
        return false;
    }
    bool StatementBody::sub_byte_range(SubByteRange&& v) {
        ...
        if (StatementKind::SUB_BYTE_RANGE==(*this).kind) {
            ...
            std::get<32>((*this).union_variant_65).sub_byte_range = std::move(v);
            return true;
        }
        return false;
    }
    const ExpressionRef* StatementBody::target() const {
        ...
        return std::addressof(std::get<2>((*this).union_variant_65).target);
        }
        if (StatementKind::YIELD==(*this).kind) {
        if(!std::holds_alternative<union_struct_68>(union_variant_65)) {
            return nullptr;
        }
        return std::addressof(std::get<3>((*this).union_variant_65).target);
        }
        if (StatementKind::APPEND==(*this).kind) {
        if(!std::holds_alternative<union_struct_69>(union_variant_65)) {
            return nullptr;
        }
        return std::addressof(std::get<4>((*this).union_variant_65).target);
        }
        return nullptr;
    }
    ...
    bool StatementBody::target(const ExpressionRef& v) {
        ...
        if (StatementKind::ASSIGNMENT==(*this).kind) {
            ...
            std::get<2>((*this).union_variant_65).target = v;
            return true;
        }
        if (StatementKind::YIELD==(*this).kind) {
            if(!std::holds_alternative<union_struct_68>(union_variant_65)) {
            ...
            std::get<3>((*this).union_variant_65).target = v;
            return true;
        }
        if (StatementKind::APPEND==(*this).kind) {
            if(!std::holds_alternative<union_struct_69>(union_variant_65)) {
            ...
            std::get<4>((*this).union_variant_65).target = v;
            return true;
        }
        return false;
    }
    bool StatementBody::target(ExpressionRef&& v) {
        ...
        if (StatementKind::ASSIGNMENT==(*this).kind) {
            ...
            std::get<2>((*this).union_variant_65).target = std::move(v);
            return true;
        }
        if (StatementKind::YIELD==(*this).kind) {
            if(!std::holds_alternative<union_struct_68>(union_variant_65)) {
            ...
            std::get<3>((*this).union_variant_65).target = std::move(v);
            return true;
        }
        if (StatementKind::APPEND==(*this).kind) {
            if(!std::holds_alternative<union_struct_69>(union_variant_65)) {
            ...
            std::get<4>((*this).union_variant_65).target = std::move(v);
            return true;
        }
        return false;
    }
    const ExpressionRef* StatementBody::value() const {
        ...
        return std::addressof(std::get<2>((*this).union_variant_65).value);
        }
        if (StatementKind::YIELD==(*this).kind) {
        if(!std::holds_alternative<union_struct_68>(union_variant_65)) {
            return nullptr;
        }
        return std::addressof(std::get<3>((*this).union_variant_65).value);
        }
        if (StatementKind::APPEND==(*this).kind) {
        if(!std::holds_alternative<union_struct_69>(union_variant_65)) {
            return nullptr;
        }
        return std::addressof(std::get<4>((*this).union_variant_65).value);
        }
        if (StatementKind::RETURN==(*this).kind) {
        if(!std::holds_alternative<union_struct_70>(union_variant_65)) {
            return nullptr;
        }
        return std::addressof(std::get<5>((*this).union_variant_65).value);
        }
        if (StatementKind::ERROR_RETURN==(*this).kind) {
        if(!std::holds_alternative<union_struct_71>(union_variant_65)) {
            return nullptr;
        }
        return std::addressof(std::get<6>((*this).union_variant_65).value);
        }
        return nullptr;
    }
    ...
    bool StatementBody::value(const ExpressionRef& v) {
        ...
        if (StatementKind::ASSIGNMENT==(*this).kind) {
            ...
            std::get<2>((*this).union_variant_65).value = v;
            return true;
        }
        if (StatementKind::YIELD==(*this).kind) {
            if(!std::holds_alternative<union_struct_68>(union_variant_65)) {
            ...
            std::get<3>((*this).union_variant_65).value = v;
            return true;
        }
        if (StatementKind::APPEND==(*this).kind) {
            if(!std::holds_alternative<union_struct_69>(union_variant_65)) {
            ...
            std::get<4>((*this).union_variant_65).value = v;
            return true;
        }
        if (StatementKind::RETURN==(*this).kind) {
            if(!std::holds_alternative<union_struct_70>(union_variant_65)) {
                union_variant_65 = union_struct_70();
            }
            std::get<5>((*this).union_variant_65).value = v;
            return true;
        }
        if (StatementKind::ERROR_RETURN==(*this).kind) {
            if(!std::holds_alternative<union_struct_71>(union_variant_65)) {
                union_variant_65 = union_struct_71();
            }
            std::get<6>((*this).union_variant_65).value = v;
            return true;
        }
        return false;
    }
    bool StatementBody::value(ExpressionRef&& v) {
        ...
        if (StatementKind::ASSIGNMENT==(*this).kind) {
            ...
            std::get<2>((*this).union_variant_65).value = std::move(v);
            return true;
        }
        if (StatementKind::YIELD==(*this).kind) {
            if(!std::holds_alternative<union_struct_68>(union_variant_65)) {
            ...
            std::get<3>((*this).union_variant_65).value = std::move(v);
            return true;
        }
        if (StatementKind::APPEND==(*this).kind) {
            if(!std::holds_alternative<union_struct_69>(union_variant_65)) {
            ...
            std::get<4>((*this).union_variant_65).value = std::move(v);
            return true;
        }
        if (StatementKind::RETURN==(*this).kind) {
            if(!std::holds_alternative<union_struct_70>(union_variant_65)) {
            ...
            std::get<5>((*this).union_variant_65).value = std::move(v);
            return true;
        }
        if (StatementKind::ERROR_RETURN==(*this).kind) {
            if(!std::holds_alternative<union_struct_71>(union_variant_65)) {
            ...
            std::get<6>((*this).union_variant_65).value = std::move(v);
            return true;
        }
        return false;
    }
    const VariableDecl* StatementBody::var_decl() const {
        ...
        if (StatementKind::VARIABLE_DECL==(*this).kind) {
        if(!std::holds_alternative<union_struct_83>(union_variant_65)) {
            return nullptr;
        }
        return std::addressof(std::get<18>((*this).union_variant_65).var_decl);
        }
        return nullptr;
    }
    ...
    bool StatementBody::var_decl(const VariableDecl& v) {
        ...
        if (StatementKind::VARIABLE_DECL==(*this).kind) {
            if(!std::holds_alternative<union_struct_83>(union_variant_65)) {
                union_variant_65 = union_struct_83();
            }
            std::get<18>((*this).union_variant_65).var_decl = v;
            return true;
        }
        return false;
    }
    bool StatementBody::var_decl(VariableDecl&& v) {
        ...
        if (StatementKind::VARIABLE_DECL==(*this).kind) {
            ...
            std::get<18>((*this).union_variant_65).var_decl = std::move(v);
            return true;
        }
        return false;
    }
    const IOData* StatementBody::write_data() const {
        ...
        if (StatementKind::WRITE_DATA==(*this).kind) {
        if(!std::holds_alternative<union_struct_74>(union_variant_65)) {
            return nullptr;
        }
        return std::addressof(std::get<9>((*this).union_variant_65).write_data);
        }
        return nullptr;
    }
    ...
    bool StatementBody::write_data(const IOData& v) {
        ...
        if (StatementKind::WRITE_DATA==(*this).kind) {
            if(!std::holds_alternative<union_struct_74>(union_variant_65)) {
                union_variant_65 = union_struct_74();
            }
            std::get<9>((*this).union_variant_65).write_data = v;
            return true;
        }
        return false;
    }
    bool StatementBody::write_data(IOData&& v) {
        ...
        if (StatementKind::WRITE_DATA==(*this).kind) {
            ...
            std::get<9>((*this).union_variant_65).write_data = std::move(v);
            return true;
        }
        return false;
    }
    const TypeRef* TypeBody::base_type() const {
        ...
        return std::addressof(std::get<9>((*this).union_variant_100).base_type);
        }
        ...
        return std::addressof(std::get<13>((*this).union_variant_100).base_type);
        }
        return nullptr;
    }
    ...
    bool TypeBody::base_type(const TypeRef& v) {
        ...
        if (TypeKind::ENUM==(*this).kind) {
            ...
            std::get<9>((*this).union_variant_100).base_type = v;
            return true;
        }
        if (TypeKind::VARIANT==(*this).kind) {
            return false;
        ...
        if (TypeKind::RANGE==(*this).kind) {
            ...
            std::get<13>((*this).union_variant_100).base_type = v;
            return true;
        }
        return false;
    }
    bool TypeBody::base_type(TypeRef&& v) {
        ...
        if (TypeKind::ENUM==(*this).kind) {
            ...
            std::get<9>((*this).union_variant_100).base_type = std::move(v);
            return true;
        }
        if (TypeKind::VARIANT==(*this).kind) {
            return false;
        ...
        if (TypeKind::RANGE==(*this).kind) {
            ...
            std::get<13>((*this).union_variant_100).base_type = std::move(v);
            return true;
        }
        return false;
    }
    const TypeRef* TypeBody::common_type() const {
        ...
        return std::addressof(std::get<10>((*this).union_variant_100).common_type);
        }
        return nullptr;
    }
    ...
    bool TypeBody::common_type(const TypeRef& v) {
        ...
        if (TypeKind::VARIANT==(*this).kind) {
            ...
            std::get<10>((*this).union_variant_100).common_type = v;
            return true;
        }
        return false;
    }
    bool TypeBody::common_type(TypeRef&& v) {
        ...
        if (TypeKind::VARIANT==(*this).kind) {
            ...
            std::get<10>((*this).union_variant_100).common_type = std::move(v);
            return true;
        }
        return false;
    }
    const TypeRef* TypeBody::element_type() const {
        ...
        return std::addressof(std::get<5>((*this).union_variant_100).element_type);
        }
        if (TypeKind::VECTOR==(*this).kind) {
        if(!std::holds_alternative<union_struct_106>(union_variant_100)) {
            return nullptr;
        }
        return std::addressof(std::get<6>((*this).union_variant_100).element_type);
        }
        return nullptr;
    }
    ...
    bool TypeBody::element_type(const TypeRef& v) {
        ...
        if (TypeKind::ARRAY==(*this).kind) {
            ...
            std::get<5>((*this).union_variant_100).element_type = v;
            return true;
        }
        if (TypeKind::VECTOR==(*this).kind) {
            if(!std::holds_alternative<union_struct_106>(union_variant_100)) {
            ...
            std::get<6>((*this).union_variant_100).element_type = v;
            return true;
        }
        return false;
    }
    bool TypeBody::element_type(TypeRef&& v) {
        ...
        if (TypeKind::ARRAY==(*this).kind) {
            ...
            std::get<5>((*this).union_variant_100).element_type = std::move(v);
            return true;
        }
        if (TypeKind::VECTOR==(*this).kind) {
            if(!std::holds_alternative<union_struct_106>(union_variant_100)) {
            ...
            std::get<6>((*this).union_variant_100).element_type = std::move(v);
            return true;
        }
        return false;
    }
    const StatementRef* TypeBody::id() const {
        ...
        return std::addressof(std::get<7>((*this).union_variant_100).id);
        }
        if (TypeKind::RECURSIVE_STRUCT==(*this).kind) {
        if(!std::holds_alternative<union_struct_108>(union_variant_100)) {
            return nullptr;
        }
        return std::addressof(std::get<8>((*this).union_variant_100).id);
        }
        if (TypeKind::ENUM==(*this).kind) {
        if(!std::holds_alternative<union_struct_109>(union_variant_100)) {
            return nullptr;
        }
        return std::addressof(std::get<9>((*this).union_variant_100).id);
        }
        return nullptr;
    }
    ...
    bool TypeBody::id(const StatementRef& v) {
        ...
        if (TypeKind::STRUCT==(*this).kind) {
            ...
            std::get<7>((*this).union_variant_100).id = v;
            return true;
        }
        if (TypeKind::RECURSIVE_STRUCT==(*this).kind) {
            if(!std::holds_alternative<union_struct_108>(union_variant_100)) {
            ...
            std::get<8>((*this).union_variant_100).id = v;
            return true;
        }
        if (TypeKind::ENUM==(*this).kind) {
            if(!std::holds_alternative<union_struct_109>(union_variant_100)) {
            ...
            std::get<9>((*this).union_variant_100).id = v;
            return true;
        }
        return false;
    }
    bool TypeBody::id(StatementRef&& v) {
        ...
        if (TypeKind::STRUCT==(*this).kind) {
            ...
            std::get<7>((*this).union_variant_100).id = std::move(v);
            return true;
        }
        if (TypeKind::RECURSIVE_STRUCT==(*this).kind) {
            if(!std::holds_alternative<union_struct_108>(union_variant_100)) {
            ...
            std::get<8>((*this).union_variant_100).id = std::move(v);
            return true;
        }
        if (TypeKind::ENUM==(*this).kind) {
            if(!std::holds_alternative<union_struct_109>(union_variant_100)) {
            ...
            std::get<9>((*this).union_variant_100).id = std::move(v);
            return true;
        }
        return false;
    }
    const TypeRef* TypeBody::inner_type() const {
        ...
        return std::addressof(std::get<11>((*this).union_variant_100).inner_type);
        }
        return nullptr;
    }
    ...
    bool TypeBody::inner_type(const TypeRef& v) {
        ...
        if (TypeKind::OPTIONAL==(*this).kind) {
            ...
            std::get<11>((*this).union_variant_100).inner_type = v;
            return true;
        }
        return false;
    }
    bool TypeBody::inner_type(TypeRef&& v) {
        ...
        if (TypeKind::OPTIONAL==(*this).kind) {
            ...
            std::get<11>((*this).union_variant_100).inner_type = std::move(v);
            return true;
        }
        return false;
    }
    const Varint* TypeBody::length() const {
        ...
        return std::addressof(std::get<5>((*this).union_variant_100).length);
        }
        return nullptr;
    }
    ...
    bool TypeBody::length(const Varint& v) {
        ...
        if (TypeKind::ARRAY==(*this).kind) {
            ...
            std::get<5>((*this).union_variant_100).length = v;
            return true;
        }
        return false;
    }
    bool TypeBody::length(Varint&& v) {
        ...
        if (TypeKind::ARRAY==(*this).kind) {
            ...
            std::get<5>((*this).union_variant_100).length = std::move(v);
            return true;
        }
        return false;
    }
    const Types* TypeBody::members() const {
        ...
        return std::addressof(std::get<10>((*this).union_variant_100).members);
        }
        return nullptr;
    }
    ...
    bool TypeBody::members(const Types& v) {
        ...
        if (TypeKind::VARIANT==(*this).kind) {
            ...
            std::get<10>((*this).union_variant_100).members = v;
            return true;
        }
        return false;
    }
    bool TypeBody::members(Types&& v) {
        ...
        if (TypeKind::VARIANT==(*this).kind) {
            ...
            std::get<10>((*this).union_variant_100).members = std::move(v);
            return true;
        }
        return false;
    }
    const Types* TypeBody::params() const {
        ...
        return std::addressof(std::get<14>((*this).union_variant_100).params);
        }
        return nullptr;
    }
    ...
    bool TypeBody::params(const Types& v) {
        ...
        if (TypeKind::FUNCTION==(*this).kind) {
            ...
            std::get<14>((*this).union_variant_100).params = v;
            return true;
        }
        return false;
    }
    bool TypeBody::params(Types&& v) {
        ...
        if (TypeKind::FUNCTION==(*this).kind) {
            ...
            std::get<14>((*this).union_variant_100).params = std::move(v);
            return true;
        }
        return false;
    }
    const TypeRef* TypeBody::pointee_type() const {
        ...
        return std::addressof(std::get<12>((*this).union_variant_100).pointee_type);
        }
        return nullptr;
    }
    ...
    bool TypeBody::pointee_type(const TypeRef& v) {
        ...
        if (TypeKind::PTR==(*this).kind) {
            ...
            std::get<12>((*this).union_variant_100).pointee_type = v;
            return true;
        }
        return false;
    }
    bool TypeBody::pointee_type(TypeRef&& v) {
        ...
        if (TypeKind::PTR==(*this).kind) {
            ...
            std::get<12>((*this).union_variant_100).pointee_type = std::move(v);
            return true;
        }
        return false;
    }
    const StatementRef* TypeBody::related_field() const {
        ...
        return std::addressof(std::get<10>((*this).union_variant_100).related_field);
        }
        return nullptr;
    }
    ...
    bool TypeBody::related_field(const StatementRef& v) {
        ...
        if (TypeKind::VARIANT==(*this).kind) {
            ...
            std::get<10>((*this).union_variant_100).related_field = v;
            return true;
        }
        return false;
    }
    bool TypeBody::related_field(StatementRef&& v) {
        ...
        if (TypeKind::VARIANT==(*this).kind) {
            ...
            std::get<10>((*this).union_variant_100).related_field = std::move(v);
            return true;
        }
        return false;
    }
    const TypeRef* TypeBody::return_type() const {
        ...
        return std::addressof(std::get<14>((*this).union_variant_100).return_type);
        }
        return nullptr;
    }
    ...
    bool TypeBody::return_type(const TypeRef& v) {
        ...
        if (TypeKind::FUNCTION==(*this).kind) {
            ...
            std::get<14>((*this).union_variant_100).return_type = v;
            return true;
        }
        return false;
    }
    bool TypeBody::return_type(TypeRef&& v) {
        ...
        if (TypeKind::FUNCTION==(*this).kind) {
            ...
            std::get<14>((*this).union_variant_100).return_type = std::move(v);
            return true;
        }
        return false;
    }
    const Varint* TypeBody::size() const {
        ...
        return std::addressof(std::get<1>((*this).union_variant_100).size);
        }
        if (TypeKind::UINT==(*this).kind) {
        if(!std::holds_alternative<union_struct_102>(union_variant_100)) {
            return nullptr;
        }
        return std::addressof(std::get<2>((*this).union_variant_100).size);
        }
        if (TypeKind::FLOAT==(*this).kind) {
        if(!std::holds_alternative<union_struct_103>(union_variant_100)) {
            return nullptr;
        }
        return std::addressof(std::get<3>((*this).union_variant_100).size);
        }
        return nullptr;
    }
    ...
    bool TypeBody::size(const Varint& v) {
        if (TypeKind::INT==(*this).kind) {
            ...
            std::get<1>((*this).union_variant_100).size = v;
            return true;
        }
        if (TypeKind::UINT==(*this).kind) {
            if(!std::holds_alternative<union_struct_102>(union_variant_100)) {
            ...
            std::get<2>((*this).union_variant_100).size = v;
            return true;
        }
        if (TypeKind::FLOAT==(*this).kind) {
            if(!std::holds_alternative<union_struct_103>(union_variant_100)) {
            ...
            std::get<3>((*this).union_variant_100).size = v;
            return true;
        }
        return false;
    }
    bool TypeBody::size(Varint&& v) {
        if (TypeKind::INT==(*this).kind) {
            ...
            std::get<1>((*this).union_variant_100).size = std::move(v);
            return true;
        }
        if (TypeKind::UINT==(*this).kind) {
            if(!std::holds_alternative<union_struct_102>(union_variant_100)) {
            ...
            std::get<2>((*this).union_variant_100).size = std::move(v);
            return true;
        }
        if (TypeKind::FLOAT==(*this).kind) {
            if(!std::holds_alternative<union_struct_103>(union_variant_100)) {
            ...
            std::get<3>((*this).union_variant_100).size = std::move(v);
            return true;
        }
        return false;
    }
    ::futils::error::Error<> Varint::encode(::futils::binary::writer& w) const {
        if((*this).prefix()==0) {
            ...
            tmp115 = (*this).value();
            tmp115 |= std::uint8_t(0)<<6;
            if (!::futils::binary::write_num(w,tmp115,true)) {
    ...
    ::futils::error::Error<> Varint::decode(::futils::binary::reader& r) {
        ...
        std::uint8_t tmp116 = (r.top() >> 6 ) & 0x3;
        (*this).prefix(tmp116);
        if((*this).prefix()==0) {
            ...
            tmp117 &= ~(std::uint8_t(0x3)<<6);
            (*this).value(tmp117);
        }
        else 
        if((*this).prefix()==1) {
            std::uint16_t tmp118 = 0;
            if(!::futils::binary::read_num(r,tmp118,true)) {
                return ::futils::error::Error<>("decode: Varint::value: read bit field failed",::futils::error::Category::lib);
            }
            tmp118 &= ~(std::uint16_t(0x3)<<14);
            (*this).value(tmp118);
        }
        else 
        if((*this).prefix()==2) {
            std::uint32_t tmp119 = 0;
            if(!::futils::binary::read_num(r,tmp119,true)) {
                return ::futils::error::Error<>("decode: Varint::value: read bit field failed",::futils::error::Category::lib);
            }
            tmp119 &= ~(std::uint32_t(0x3)<<30);
            (*this).value(tmp119);
        }
        else 
        if((*this).prefix()==3) {
    ...
    ::futils::error::Error<> String::encode(::futils::binary::writer& w) const {
        ...
        if (tmp_121_!=(*this).data.size()) {
            return ::futils::error::Error<>("encode: String::data: dynamic length is not compatible with its length; tmp_121_!=(*this).data.size()",::futils::error::Category::lib);
        }
    ...
    ::futils::error::Error<> LoweredStatement::encode(::futils::binary::writer& w) const {
        auto tmp_123_ = static_cast<std::uint8_t>((*this).lowering_type);
    ...
    ::futils::error::Error<> LoweredStatement::decode(::futils::binary::reader& r) {
        ...
        (*this).lowering_type = static_cast<LoweringType>(tmp_124_);
    ...
    ::futils::error::Error<> LoweredExpression::encode(::futils::binary::writer& w) const {
        auto tmp_125_ = static_cast<std::uint8_t>((*this).lowering_type);
    ...
    ::futils::error::Error<> LoweredExpression::decode(::futils::binary::reader& r) {
        ...
        (*this).lowering_type = static_cast<LoweringType>(tmp_126_);
    ...
    ::futils::error::Error<> RefAlias::encode(::futils::binary::writer& w) const {
        auto tmp_127_ = static_cast<std::uint8_t>((*this).hint);
    ...
    ::futils::error::Error<> RefAlias::decode(::futils::binary::reader& r) {
        ...
        (*this).hint = static_cast<AliasHint>(tmp_128_);
    ...
    ::futils::error::Error<> Expressions::encode(::futils::binary::writer& w) const {
        ...
        if (tmp_129_!=(*this).container.size()) {
            return ::futils::error::Error<>("encode: Expressions::container: dynamic length is not compatible with its length; tmp_129_!=(*this).container.size()",::futils::error::Category::lib);
        }
    ...
    ::futils::error::Error<> Size::encode(::futils::binary::writer& w) const {
        auto tmp_134_ = static_cast<std::uint8_t>((*this).unit);
        if (!::futils::binary::write_num(w,static_cast<std::uint8_t>(tmp_134_) ,true)) {
    ...
    ::futils::error::Error<> Size::decode(::futils::binary::reader& r) {
        ...
        (*this).unit = static_cast<SizeUnit>(tmp_135_);
        if (SizeUnit::UNKNOWN==(*this).unit) {
    ...
    ::futils::error::Error<> ExpressionBody::encode(::futils::binary::writer& w) const {
        ...
        auto tmp_136_ = static_cast<std::uint8_t>((*this).kind);
        ...
        if (ExpressionKind::LITERAL_INT==(*this).kind) {
            ...
            auto tmp_137_ = static_cast<std::uint8_t>(std::get<8>((*this).union_variant_13).bop);
            ...
            auto tmp_138_ = static_cast<std::uint8_t>(std::get<9>((*this).union_variant_13).uop);
            ...
            auto tmp_139_ = static_cast<std::uint8_t>(std::get<13>((*this).union_variant_13).cast_kind);
            ...
            auto tmp_140_ = static_cast<std::uint8_t>(std::get<16>((*this).union_variant_13).stream_type);
            ...
            auto tmp_141_ = static_cast<std::uint8_t>(std::get<16>((*this).union_variant_13).unit);
            ...
            auto tmp_142_ = static_cast<std::uint8_t>(std::get<17>((*this).union_variant_13).stream_type);
            ...
            auto tmp_143_ = static_cast<std::uint8_t>(std::get<18>((*this).union_variant_13).stream_type);
            ...
            auto tmp_144_ = static_cast<std::uint8_t>(std::get<32>((*this).union_variant_13).setter_status);
    ...
    ::futils::error::Error<> ExpressionBody::decode(::futils::binary::reader& r) {
        ...
        (*this).kind = static_cast<ExpressionKind>(tmp_145_);
        if (ExpressionKind::LITERAL_INT==(*this).kind) {
            if(!std::holds_alternative<union_struct_14>(union_variant_13)) {
                union_variant_13 = union_struct_14();
            }
            ...
            std::get<8>((*this).union_variant_13).bop = static_cast<BinaryOp>(tmp_146_);
            ...
            std::get<9>((*this).union_variant_13).uop = static_cast<UnaryOp>(tmp_147_);
            ...
            std::get<13>((*this).union_variant_13).cast_kind = static_cast<CastType>(tmp_148_);
        }
        else if (ExpressionKind::RANGE==(*this).kind) {
            if(!std::holds_alternative<union_struct_27>(union_variant_13)) {
                union_variant_13 = union_struct_27();
            ...
            std::get<16>((*this).union_variant_13).stream_type = static_cast<StreamType>(tmp_149_);
            ...
            std::get<16>((*this).union_variant_13).unit = static_cast<SizeUnit>(tmp_150_);
            if (!((std::get<16>((*this).union_variant_13).unit == SizeUnit::BIT_FIXED) || (std::get<16>((*this).union_variant_13).unit == SizeUnit::BYTE_FIXED))) {
            ...
            std::get<17>((*this).union_variant_13).stream_type = static_cast<StreamType>(tmp_151_);
        }
        else if (ExpressionKind::CAN_READ_STREAM==(*this).kind) {
            if(!std::holds_alternative<union_struct_31>(union_variant_13)) {
                union_variant_13 = union_struct_31();
            ...
            std::get<18>((*this).union_variant_13).stream_type = static_cast<StreamType>(tmp_152_);
            ...
            std::get<32>((*this).union_variant_13).setter_status = static_cast<SetterStatus>(tmp_153_);
        }
        return ::futils::error::Error<>();
    }
    ...
    ::futils::error::Error<> SubByteRange::encode(::futils::binary::writer& w) const {
        auto tmp_154_ = static_cast<std::uint8_t>((*this).stream_type);
        ...
        auto tmp_155_ = static_cast<std::uint8_t>((*this).range_type);
        ...
        if (SubByteRangeType::bytes==(*this).range_type) {
            if(!std::holds_alternative<union_struct_48>(union_variant_47)) {
                return ::futils::error::Error<>("encode: SubByteRange: union_variant_47 variant alternative union_struct_48 is not set",::futils::error::Category::lib);
            }
            if (auto err = std::get<1>((*this).union_variant_47).length.encode(w)) {
                return err;
            }
        }
        else if (SubByteRangeType::seek_bytes==(*this).range_type) {
            if(!std::holds_alternative<union_struct_49>(union_variant_47)) {
                return ::futils::error::Error<>("encode: SubByteRange: union_variant_47 variant alternative union_struct_49 is not set",::futils::error::Category::lib);
            }
            if (auto err = std::get<2>((*this).union_variant_47).offset.encode(w)) {
                return err;
            }
            if (auto err = std::get<2>((*this).union_variant_47).length.encode(w)) {
                return err;
            }
        }
        else if (SubByteRangeType::expression==(*this).range_type) {
            if(!std::holds_alternative<union_struct_50>(union_variant_47)) {
                return ::futils::error::Error<>("encode: SubByteRange: union_variant_47 variant alternative union_struct_50 is not set",::futils::error::Category::lib);
            }
            if (auto err = std::get<3>((*this).union_variant_47).expression.encode(w)) {
                return err;
            }
        }
    ...
    ::futils::error::Error<> SubByteRange::decode(::futils::binary::reader& r) {
        ...
        (*this).stream_type = static_cast<StreamType>(tmp_156_);
        ...
        (*this).range_type = static_cast<SubByteRangeType>(tmp_157_);
        if (SubByteRangeType::bytes==(*this).range_type) {
            if(!std::holds_alternative<union_struct_48>(union_variant_47)) {
                union_variant_47 = union_struct_48();
            }
            if (auto err = std::get<1>((*this).union_variant_47).length.decode(r)) {
                return err;
            }
        }
        else if (SubByteRangeType::seek_bytes==(*this).range_type) {
            ...
            if (auto err = std::get<2>((*this).union_variant_47).offset.decode(r)) {
                return err;
            }
            if (auto err = std::get<2>((*this).union_variant_47).length.decode(r)) {
                return err;
            }
        }
        else if (SubByteRangeType::expression==(*this).range_type) {
            ...
            if (auto err = std::get<3>((*this).union_variant_47).expression.decode(r)) {
                return err;
            }
        }
    ...
    ::futils::error::Error<> LoweredStatements::encode(::futils::binary::writer& w) const {
        ...
        if (tmp_158_!=(*this).container.size()) {
            return ::futils::error::Error<>("encode: LoweredStatements::container: dynamic length is not compatible with its length; tmp_158_!=(*this).container.size()",::futils::error::Category::lib);
        }
    ...
    ::futils::error::Error<> LoweredExpressions::encode(::futils::binary::writer& w) const {
        ...
        if (tmp_163_!=(*this).container.size()) {
            return ::futils::error::Error<>("encode: LoweredExpressions::container: dynamic length is not compatible with its length; tmp_163_!=(*this).container.size()",::futils::error::Category::lib);
        }
    ...
    ::futils::error::Error<> Block::encode(::futils::binary::writer& w) const {
        ...
        if (tmp_168_!=(*this).container.size()) {
            return ::futils::error::Error<>("encode: Block::container: dynamic length is not compatible with its length; tmp_168_!=(*this).container.size()",::futils::error::Category::lib);
        }
        for (auto& tmp_169_ : (*this).container) {
    ...
    ::futils::error::Error<> Block::decode(::futils::binary::reader& r) {
        ...
        for (size_t  tmp_172_= 0; tmp_172_<tmp_170_; ++tmp_172_ ) {
            StatementRef tmp_171_;
            if (auto err = tmp_171_.decode(r)) {
                return err;
            }
            (*this).container.push_back(std::move(tmp_171_));
        }
        return ::futils::error::Error<>();
    }
    ...
    ::futils::error::Error<> LoopStatement::encode(::futils::binary::writer& w) const {
        auto tmp_173_ = static_cast<std::uint8_t>((*this).loop_type);
        ...
        if (LoopType::INFINITE==(*this).loop_type) {
            ...
            if(!std::holds_alternative<union_struct_54>(union_variant_52)) {
                return ::futils::error::Error<>("encode: LoopStatement: union_variant_52 variant alternative union_struct_54 is not set",::futils::error::Category::lib);
            }
            if (auto err = std::get<2>((*this).union_variant_52).condition.encode(w)) {
                return err;
            }
        }
        else if (LoopType::FOR_EACH==(*this).loop_type) {
            if(!std::holds_alternative<union_struct_55>(union_variant_52)) {
                return ::futils::error::Error<>("encode: LoopStatement: union_variant_52 variant alternative union_struct_55 is not set",::futils::error::Category::lib);
            }
            if (auto err = std::get<3>((*this).union_variant_52).item_var.encode(w)) {
                return err;
            }
            if (auto err = std::get<3>((*this).union_variant_52).collection.encode(w)) {
                return err;
            }
        }
        else if (LoopType::FOR==(*this).loop_type) {
            if(!std::holds_alternative<union_struct_56>(union_variant_52)) {
                return ::futils::error::Error<>("encode: LoopStatement: union_variant_52 variant alternative union_struct_56 is not set",::futils::error::Category::lib);
            }
            if (auto err = std::get<4>((*this).union_variant_52).init.encode(w)) {
                return err;
            }
            if (auto err = std::get<4>((*this).union_variant_52).condition.encode(w)) {
                return err;
            }
            if (auto err = std::get<4>((*this).union_variant_52).increment.encode(w)) {
                return err;
            }
        }
        if (auto err = (*this).body.encode(w)) {
    ...
    ::futils::error::Error<> LoopStatement::decode(::futils::binary::reader& r) {
        ...
        (*this).loop_type = static_cast<LoopType>(tmp_174_);
        if (LoopType::INFINITE==(*this).loop_type) {
            ...
            if (auto err = std::get<2>((*this).union_variant_52).condition.decode(r)) {
                return err;
            }
        }
        else if (LoopType::FOR_EACH==(*this).loop_type) {
            ...
            if (auto err = std::get<3>((*this).union_variant_52).item_var.decode(r)) {
                return err;
            }
            if (auto err = std::get<3>((*this).union_variant_52).collection.decode(r)) {
                return err;
            }
        }
        else if (LoopType::FOR==(*this).loop_type) {
            ...
            if (auto err = std::get<4>((*this).union_variant_52).init.decode(r)) {
                return err;
            }
            if (auto err = std::get<4>((*this).union_variant_52).condition.decode(r)) {
                return err;
            }
            if (auto err = std::get<4>((*this).union_variant_52).increment.decode(r)) {
                return err;
            }
        }
        if (auto err = (*this).body.decode(r)) {
    ...
    ::futils::error::Error<> PropertyDecl::encode(::futils::binary::writer& w) const {
        ...
        auto tmp_175_ = static_cast<std::uint8_t>((*this).merge_mode);
        ...
        if ((*this).merge_mode == MergeMode::STRICT_TYPE) {
            if(!std::holds_alternative<union_struct_63>(union_variant_62)) {
                return ::futils::error::Error<>("encode: PropertyDecl: union_variant_62 variant alternative union_struct_63 is not set",::futils::error::Category::lib);
            }
            if (auto err = std::get<1>((*this).union_variant_62).cond.encode(w)) {
                return err;
            }
        }
        if (auto err = (*this).members.encode(w)) {
    ...
    ::futils::error::Error<> PropertyDecl::decode(::futils::binary::reader& r) {
        ...
        (*this).merge_mode = static_cast<MergeMode>(tmp_176_);
        if ((*this).merge_mode == MergeMode::STRICT_TYPE) {
            if(!std::holds_alternative<union_struct_63>(union_variant_62)) {
                union_variant_62 = union_struct_63();
            }
            if (auto err = std::get<1>((*this).union_variant_62).cond.decode(r)) {
                return err;
            }
        }
        if (auto err = (*this).members.decode(r)) {
    ...
    ::futils::error::Error<> InitCheck::decode(::futils::binary::reader& r) {
        ...
        (*this).stream_type = static_cast<StreamType>(tmp_178_);
    ...
    ::futils::error::Error<> StatementBody::encode(::futils::binary::writer& w) const {
        auto tmp_179_ = static_cast<std::uint8_t>((*this).kind);
        ...
        if (StatementKind::BLOCK==(*this).kind) {
            if(!std::holds_alternative<union_struct_66>(union_variant_65)) {
                return ::futils::error::Error<>("encode: StatementBody: union_variant_65 variant alternative union_struct_66 is not set",::futils::error::Category::lib);
            }
            if (auto err = std::get<1>((*this).union_variant_65).block.encode(w)) {
                return err;
            }
        }
        else if (StatementKind::ASSIGNMENT==(*this).kind) {
            if(!std::holds_alternative<union_struct_67>(union_variant_65)) {
                return ::futils::error::Error<>("encode: StatementBody: union_variant_65 variant alternative union_struct_67 is not set",::futils::error::Category::lib);
            }
            if (auto err = std::get<2>((*this).union_variant_65).target.encode(w)) {
                return err;
            }
            if (auto err = std::get<2>((*this).union_variant_65).value.encode(w)) {
                return err;
            }
            if (auto err = std::get<2>((*this).union_variant_65).previous_assignment.encode(w)) {
                return err;
            }
        }
        else if (StatementKind::YIELD==(*this).kind) {
            if(!std::holds_alternative<union_struct_68>(union_variant_65)) {
                return ::futils::error::Error<>("encode: StatementBody: union_variant_65 variant alternative union_struct_68 is not set",::futils::error::Category::lib);
            }
            if (auto err = std::get<3>((*this).union_variant_65).target.encode(w)) {
                return err;
            }
            if (auto err = std::get<3>((*this).union_variant_65).value.encode(w)) {
                return err;
            }
            if (auto err = std::get<3>((*this).union_variant_65).previous_assignment.encode(w)) {
                return err;
            }
        }
        else if (StatementKind::APPEND==(*this).kind) {
            if(!std::holds_alternative<union_struct_69>(union_variant_65)) {
                return ::futils::error::Error<>("encode: StatementBody: union_variant_65 variant alternative union_struct_69 is not set",::futils::error::Category::lib);
            }
            if (auto err = std::get<4>((*this).union_variant_65).target.encode(w)) {
                return err;
            }
            if (auto err = std::get<4>((*this).union_variant_65).value.encode(w)) {
                return err;
            }
        }
        else if (StatementKind::RETURN==(*this).kind) {
            if(!std::holds_alternative<union_struct_70>(union_variant_65)) {
                return ::futils::error::Error<>("encode: StatementBody: union_variant_65 variant alternative union_struct_70 is not set",::futils::error::Category::lib);
            }
            if (auto err = std::get<5>((*this).union_variant_65).value.encode(w)) {
                return err;
            }
        }
        else if (StatementKind::ERROR_RETURN==(*this).kind) {
            if(!std::holds_alternative<union_struct_71>(union_variant_65)) {
                return ::futils::error::Error<>("encode: StatementBody: union_variant_65 variant alternative union_struct_71 is not set",::futils::error::Category::lib);
            }
            if (auto err = std::get<6>((*this).union_variant_65).value.encode(w)) {
                return err;
            }
        }
        else if (StatementKind::ASSERT==(*this).kind) {
            if(!std::holds_alternative<union_struct_72>(union_variant_65)) {
                return ::futils::error::Error<>("encode: StatementBody: union_variant_65 variant alternative union_struct_72 is not set",::futils::error::Category::lib);
            }
            if (auto err = std::get<7>((*this).union_variant_65).assert_desc.encode(w)) {
                return err;
            }
        }
        else if (StatementKind::READ_DATA==(*this).kind) {
            if(!std::holds_alternative<union_struct_73>(union_variant_65)) {
                return ::futils::error::Error<>("encode: StatementBody: union_variant_65 variant alternative union_struct_73 is not set",::futils::error::Category::lib);
            }
            if (auto err = std::get<8>((*this).union_variant_65).read_data.encode(w)) {
                return err;
            }
        }
        else if (StatementKind::WRITE_DATA==(*this).kind) {
            if(!std::holds_alternative<union_struct_74>(union_variant_65)) {
                return ::futils::error::Error<>("encode: StatementBody: union_variant_65 variant alternative union_struct_74 is not set",::futils::error::Category::lib);
            }
            if (auto err = std::get<9>((*this).union_variant_65).write_data.encode(w)) {
                return err;
            }
        }
        else if (StatementKind::SEEK_STREAM==(*this).kind) {
            if(!std::holds_alternative<union_struct_75>(union_variant_65)) {
                return ::futils::error::Error<>("encode: StatementBody: union_variant_65 variant alternative union_struct_75 is not set",::futils::error::Category::lib);
            }
            if (auto err = std::get<10>((*this).union_variant_65).offset.encode(w)) {
                return err;
            }
            auto tmp_180_ = static_cast<std::uint8_t>(std::get<10>((*this).union_variant_65).stream_type);
            ...
            if(!std::holds_alternative<union_struct_76>(union_variant_65)) {
                return ::futils::error::Error<>("encode: StatementBody: union_variant_65 variant alternative union_struct_76 is not set",::futils::error::Category::lib);
            }
            if (auto err = std::get<11>((*this).union_variant_65).if_statement.encode(w)) {
                return err;
            }
        }
        else if (StatementKind::LOOP_STATEMENT==(*this).kind) {
            if(!std::holds_alternative<union_struct_77>(union_variant_65)) {
                return ::futils::error::Error<>("encode: StatementBody: union_variant_65 variant alternative union_struct_77 is not set",::futils::error::Category::lib);
            }
            if (auto err = std::get<12>((*this).union_variant_65).loop.encode(w)) {
                return err;
            }
        }
        else if (StatementKind::MATCH_STATEMENT==(*this).kind) {
            if(!std::holds_alternative<union_struct_78>(union_variant_65)) {
                return ::futils::error::Error<>("encode: StatementBody: union_variant_65 variant alternative union_struct_78 is not set",::futils::error::Category::lib);
            }
            if (auto err = std::get<13>((*this).union_variant_65).match_statement.encode(w)) {
                return err;
            }
        }
        else if (StatementKind::MATCH_BRANCH==(*this).kind) {
            if(!std::holds_alternative<union_struct_79>(union_variant_65)) {
                return ::futils::error::Error<>("encode: StatementBody: union_variant_65 variant alternative union_struct_79 is not set",::futils::error::Category::lib);
            }
            if (auto err = std::get<14>((*this).union_variant_65).match_branch.encode(w)) {
                return err;
            }
        }
        else if (StatementKind::BREAK==(*this).kind) {
            if(!std::holds_alternative<union_struct_80>(union_variant_65)) {
                return ::futils::error::Error<>("encode: StatementBody: union_variant_65 variant alternative union_struct_80 is not set",::futils::error::Category::lib);
            }
            if (auto err = std::get<15>((*this).union_variant_65).break_.encode(w)) {
                return err;
            }
        }
        else if (StatementKind::CONTINUE==(*this).kind) {
            if(!std::holds_alternative<union_struct_81>(union_variant_65)) {
                return ::futils::error::Error<>("encode: StatementBody: union_variant_65 variant alternative union_struct_81 is not set",::futils::error::Category::lib);
            }
            if (auto err = std::get<16>((*this).union_variant_65).continue_.encode(w)) {
                return err;
            }
        }
        else if (StatementKind::FUNCTION_DECL==(*this).kind) {
            if(!std::holds_alternative<union_struct_82>(union_variant_65)) {
                return ::futils::error::Error<>("encode: StatementBody: union_variant_65 variant alternative union_struct_82 is not set",::futils::error::Category::lib);
            }
            if (auto err = std::get<17>((*this).union_variant_65).func_decl.encode(w)) {
                return err;
            }
        }
        else if (StatementKind::VARIABLE_DECL==(*this).kind) {
            if(!std::holds_alternative<union_struct_83>(union_variant_65)) {
                return ::futils::error::Error<>("encode: StatementBody: union_variant_65 variant alternative union_struct_83 is not set",::futils::error::Category::lib);
            }
            if (auto err = std::get<18>((*this).union_variant_65).var_decl.encode(w)) {
                return err;
            }
        }
        else if (StatementKind::PARAMETER_DECL==(*this).kind) {
            if(!std::holds_alternative<union_struct_84>(union_variant_65)) {
                return ::futils::error::Error<>("encode: StatementBody: union_variant_65 variant alternative union_struct_84 is not set",::futils::error::Category::lib);
            }
            if (auto err = std::get<19>((*this).union_variant_65).param_decl.encode(w)) {
                return err;
            }
        }
        else if (StatementKind::FIELD_DECL==(*this).kind) {
            if(!std::holds_alternative<union_struct_85>(union_variant_65)) {
                return ::futils::error::Error<>("encode: StatementBody: union_variant_65 variant alternative union_struct_85 is not set",::futils::error::Category::lib);
            }
            if (auto err = std::get<20>((*this).union_variant_65).field_decl.encode(w)) {
                return err;
            }
        }
        else if (StatementKind::ENUM_DECL==(*this).kind) {
            if(!std::holds_alternative<union_struct_86>(union_variant_65)) {
                return ::futils::error::Error<>("encode: StatementBody: union_variant_65 variant alternative union_struct_86 is not set",::futils::error::Category::lib);
            }
            if (auto err = std::get<21>((*this).union_variant_65).enum_decl.encode(w)) {
                return err;
            }
        }
        else if (StatementKind::ENUM_MEMBER_DECL==(*this).kind) {
            if(!std::holds_alternative<union_struct_87>(union_variant_65)) {
                return ::futils::error::Error<>("encode: StatementBody: union_variant_65 variant alternative union_struct_87 is not set",::futils::error::Category::lib);
            }
            if (auto err = std::get<22>((*this).union_variant_65).enum_member_decl.encode(w)) {
                return err;
            }
        }
        else if (StatementKind::STRUCT_DECL==(*this).kind) {
            if(!std::holds_alternative<union_struct_88>(union_variant_65)) {
                return ::futils::error::Error<>("encode: StatementBody: union_variant_65 variant alternative union_struct_88 is not set",::futils::error::Category::lib);
            }
            if (auto err = std::get<23>((*this).union_variant_65).struct_decl.encode(w)) {
                return err;
            }
        }
        else if (StatementKind::PROGRAM_DECL==(*this).kind) {
            if(!std::holds_alternative<union_struct_89>(union_variant_65)) {
                return ::futils::error::Error<>("encode: StatementBody: union_variant_65 variant alternative union_struct_89 is not set",::futils::error::Category::lib);
            }
            if (auto err = std::get<24>((*this).union_variant_65).block.encode(w)) {
                return err;
            }
        }
        else if (StatementKind::PROPERTY_DECL==(*this).kind) {
            if(!std::holds_alternative<union_struct_90>(union_variant_65)) {
                return ::futils::error::Error<>("encode: StatementBody: union_variant_65 variant alternative union_struct_90 is not set",::futils::error::Category::lib);
            }
            if (auto err = std::get<25>((*this).union_variant_65).property_decl.encode(w)) {
                return err;
            }
        }
        else if (StatementKind::PROPERTY_MEMBER_DECL==(*this).kind) {
            if(!std::holds_alternative<union_struct_91>(union_variant_65)) {
                return ::futils::error::Error<>("encode: StatementBody: union_variant_65 variant alternative union_struct_91 is not set",::futils::error::Category::lib);
            }
            if (auto err = std::get<26>((*this).union_variant_65).property_member_decl.encode(w)) {
                return err;
            }
        }
        else if (StatementKind::METADATA==(*this).kind) {
            if(!std::holds_alternative<union_struct_92>(union_variant_65)) {
                return ::futils::error::Error<>("encode: StatementBody: union_variant_65 variant alternative union_struct_92 is not set",::futils::error::Category::lib);
            }
            if (auto err = std::get<27>((*this).union_variant_65).metadata.encode(w)) {
                return err;
            }
        }
        else if (StatementKind::IMPORT_MODULE==(*this).kind) {
            if(!std::holds_alternative<union_struct_93>(union_variant_65)) {
                return ::futils::error::Error<>("encode: StatementBody: union_variant_65 variant alternative union_struct_93 is not set",::futils::error::Category::lib);
            }
            if (auto err = std::get<28>((*this).union_variant_65).module_name.encode(w)) {
                return err;
            }
            if (auto err = std::get<28>((*this).union_variant_65).alias.encode(w)) {
                return err;
            }
        }
        else if (StatementKind::ERROR_REPORT==(*this).kind) {
            if(!std::holds_alternative<union_struct_94>(union_variant_65)) {
                return ::futils::error::Error<>("encode: StatementBody: union_variant_65 variant alternative union_struct_94 is not set",::futils::error::Category::lib);
            }
            if (auto err = std::get<29>((*this).union_variant_65).error_report.encode(w)) {
                return err;
            }
        }
        else if (StatementKind::EXPRESSION==(*this).kind) {
            if(!std::holds_alternative<union_struct_95>(union_variant_65)) {
                return ::futils::error::Error<>("encode: StatementBody: union_variant_65 variant alternative union_struct_95 is not set",::futils::error::Category::lib);
            }
            if (auto err = std::get<30>((*this).union_variant_65).expression.encode(w)) {
                return err;
            }
        }
        else if (StatementKind::LOWERED_STATEMENTS==(*this).kind) {
            if(!std::holds_alternative<union_struct_96>(union_variant_65)) {
                return ::futils::error::Error<>("encode: StatementBody: union_variant_65 variant alternative union_struct_96 is not set",::futils::error::Category::lib);
            }
            if (auto err = std::get<31>((*this).union_variant_65).lowered_statements.encode(w)) {
                return err;
            }
        }
        else if (StatementKind::SUB_BYTE_RANGE==(*this).kind) {
            if(!std::holds_alternative<union_struct_97>(union_variant_65)) {
                return ::futils::error::Error<>("encode: StatementBody: union_variant_65 variant alternative union_struct_97 is not set",::futils::error::Category::lib);
            }
            if (auto err = std::get<32>((*this).union_variant_65).sub_byte_range.encode(w)) {
                return err;
            }
        }
        else if (StatementKind::INIT_CHECK==(*this).kind) {
            if(!std::holds_alternative<union_struct_98>(union_variant_65)) {
                return ::futils::error::Error<>("encode: StatementBody: union_variant_65 variant alternative union_struct_98 is not set",::futils::error::Category::lib);
            }
            if (auto err = std::get<33>((*this).union_variant_65).init_check.encode(w)) {
                return err;
            }
        }
        return ::futils::error::Error<>();
    ...
    ::futils::error::Error<> StatementBody::decode(::futils::binary::reader& r) {
        ...
        (*this).kind = static_cast<StatementKind>(tmp_181_);
        if (StatementKind::BLOCK==(*this).kind) {
            if(!std::holds_alternative<union_struct_66>(union_variant_65)) {
                union_variant_65 = union_struct_66();
            }
            if (auto err = std::get<1>((*this).union_variant_65).block.decode(r)) {
                return err;
            }
        }
        else if (StatementKind::ASSIGNMENT==(*this).kind) {
            ...
            if (auto err = std::get<2>((*this).union_variant_65).target.decode(r)) {
                return err;
            }
            if (auto err = std::get<2>((*this).union_variant_65).value.decode(r)) {
                return err;
            }
            if (auto err = std::get<2>((*this).union_variant_65).previous_assignment.decode(r)) {
                return err;
            }
        }
        else if (StatementKind::YIELD==(*this).kind) {
            ...
            if (auto err = std::get<3>((*this).union_variant_65).target.decode(r)) {
                return err;
            }
            if (auto err = std::get<3>((*this).union_variant_65).value.decode(r)) {
                return err;
            }
            if (auto err = std::get<3>((*this).union_variant_65).previous_assignment.decode(r)) {
                return err;
            }
        }
        else if (StatementKind::APPEND==(*this).kind) {
            ...
            if (auto err = std::get<4>((*this).union_variant_65).target.decode(r)) {
                return err;
            }
            if (auto err = std::get<4>((*this).union_variant_65).value.decode(r)) {
                return err;
            }
        }
        else if (StatementKind::RETURN==(*this).kind) {
            ...
            if (auto err = std::get<5>((*this).union_variant_65).value.decode(r)) {
                return err;
            }
        }
        else if (StatementKind::ERROR_RETURN==(*this).kind) {
            ...
            if (auto err = std::get<6>((*this).union_variant_65).value.decode(r)) {
                return err;
            }
        }
        else if (StatementKind::ASSERT==(*this).kind) {
            ...
            if (auto err = std::get<7>((*this).union_variant_65).assert_desc.decode(r)) {
                return err;
            }
        }
        else if (StatementKind::READ_DATA==(*this).kind) {
            ...
            if (auto err = std::get<8>((*this).union_variant_65).read_data.decode(r)) {
                return err;
            }
        }
        else if (StatementKind::WRITE_DATA==(*this).kind) {
            ...
            if (auto err = std::get<9>((*this).union_variant_65).write_data.decode(r)) {
                return err;
            }
        }
        else if (StatementKind::SEEK_STREAM==(*this).kind) {
            ...
            std::get<10>((*this).union_variant_65).stream_type = static_cast<StreamType>(tmp_182_);
        }
        else if (StatementKind::IF_STATEMENT==(*this).kind) {
            if(!std::holds_alternative<union_struct_76>(union_variant_65)) {
                union_variant_65 = union_struct_76();
            }
            if (auto err = std::get<11>((*this).union_variant_65).if_statement.decode(r)) {
                return err;
            }
        }
        else if (StatementKind::LOOP_STATEMENT==(*this).kind) {
            ...
            if (auto err = std::get<12>((*this).union_variant_65).loop.decode(r)) {
                return err;
            }
        }
        else if (StatementKind::MATCH_STATEMENT==(*this).kind) {
            ...
            if (auto err = std::get<13>((*this).union_variant_65).match_statement.decode(r)) {
                return err;
            }
        }
        else if (StatementKind::MATCH_BRANCH==(*this).kind) {
            ...
            if (auto err = std::get<14>((*this).union_variant_65).match_branch.decode(r)) {
                return err;
            }
        }
        else if (StatementKind::BREAK==(*this).kind) {
            ...
            if (auto err = std::get<15>((*this).union_variant_65).break_.decode(r)) {
                return err;
            }
        }
        else if (StatementKind::CONTINUE==(*this).kind) {
            ...
            if (auto err = std::get<16>((*this).union_variant_65).continue_.decode(r)) {
                return err;
            }
        }
        else if (StatementKind::FUNCTION_DECL==(*this).kind) {
            ...
            if (auto err = std::get<17>((*this).union_variant_65).func_decl.decode(r)) {
                return err;
            }
        }
        else if (StatementKind::VARIABLE_DECL==(*this).kind) {
            ...
            if (auto err = std::get<18>((*this).union_variant_65).var_decl.decode(r)) {
                return err;
            }
        }
        else if (StatementKind::PARAMETER_DECL==(*this).kind) {
            ...
            if (auto err = std::get<19>((*this).union_variant_65).param_decl.decode(r)) {
                return err;
            }
        }
        else if (StatementKind::FIELD_DECL==(*this).kind) {
            ...
            if (auto err = std::get<20>((*this).union_variant_65).field_decl.decode(r)) {
                return err;
            }
        }
        else if (StatementKind::ENUM_DECL==(*this).kind) {
            ...
            if (auto err = std::get<21>((*this).union_variant_65).enum_decl.decode(r)) {
                return err;
            }
        }
        else if (StatementKind::ENUM_MEMBER_DECL==(*this).kind) {
            ...
            if (auto err = std::get<22>((*this).union_variant_65).enum_member_decl.decode(r)) {
                return err;
            }
        }
        else if (StatementKind::STRUCT_DECL==(*this).kind) {
            ...
            if (auto err = std::get<23>((*this).union_variant_65).struct_decl.decode(r)) {
                return err;
            }
        }
        else if (StatementKind::PROGRAM_DECL==(*this).kind) {
            ...
            if (auto err = std::get<24>((*this).union_variant_65).block.decode(r)) {
                return err;
            }
        }
        else if (StatementKind::PROPERTY_DECL==(*this).kind) {
            ...
            if (auto err = std::get<25>((*this).union_variant_65).property_decl.decode(r)) {
                return err;
            }
        }
        else if (StatementKind::PROPERTY_MEMBER_DECL==(*this).kind) {
            ...
            if (auto err = std::get<26>((*this).union_variant_65).property_member_decl.decode(r)) {
                return err;
            }
        }
        else if (StatementKind::METADATA==(*this).kind) {
            ...
            if (auto err = std::get<27>((*this).union_variant_65).metadata.decode(r)) {
                return err;
            }
        }
        else if (StatementKind::IMPORT_MODULE==(*this).kind) {
            ...
            if (auto err = std::get<28>((*this).union_variant_65).module_name.decode(r)) {
                return err;
            }
            if (auto err = std::get<28>((*this).union_variant_65).alias.decode(r)) {
                return err;
            }
        }
        else if (StatementKind::ERROR_REPORT==(*this).kind) {
            ...
            if (auto err = std::get<29>((*this).union_variant_65).error_report.decode(r)) {
                return err;
            }
        }
        else if (StatementKind::EXPRESSION==(*this).kind) {
            ...
            if (auto err = std::get<30>((*this).union_variant_65).expression.decode(r)) {
                return err;
            }
        }
        else if (StatementKind::LOWERED_STATEMENTS==(*this).kind) {
            ...
            if (auto err = std::get<31>((*this).union_variant_65).lowered_statements.decode(r)) {
                return err;
            }
        }
        else if (StatementKind::SUB_BYTE_RANGE==(*this).kind) {
            ...
            if (auto err = std::get<32>((*this).union_variant_65).sub_byte_range.decode(r)) {
                return err;
            }
        }
        else if (StatementKind::INIT_CHECK==(*this).kind) {
            ...
            if (auto err = std::get<33>((*this).union_variant_65).init_check.decode(r)) {
                return err;
            }
        }
        return ::futils::error::Error<>();
    ...
    ::futils::error::Error<> Types::encode(::futils::binary::writer& w) const {
        ...
        if (tmp_183_!=(*this).container.size()) {
            return ::futils::error::Error<>("encode: Types::container: dynamic length is not compatible with its length; tmp_183_!=(*this).container.size()",::futils::error::Category::lib);
        }
    ...
    ::futils::error::Error<> TypeBody::encode(::futils::binary::writer& w) const {
        ...
        if (TypeKind::INT==(*this).kind) {
            if(!std::holds_alternative<union_struct_101>(union_variant_100)) {
                return ::futils::error::Error<>("encode: TypeBody: union_variant_100 variant alternative union_struct_101 is not set",::futils::error::Category::lib);
            }
            if (auto err = std::get<1>((*this).union_variant_100).size.encode(w)) {
                return err;
            }
        }
        else if (TypeKind::UINT==(*this).kind) {
            if(!std::holds_alternative<union_struct_102>(union_variant_100)) {
                return ::futils::error::Error<>("encode: TypeBody: union_variant_100 variant alternative union_struct_102 is not set",::futils::error::Category::lib);
            }
            if (auto err = std::get<2>((*this).union_variant_100).size.encode(w)) {
                return err;
            }
        }
        else if (TypeKind::FLOAT==(*this).kind) {
            if(!std::holds_alternative<union_struct_103>(union_variant_100)) {
                return ::futils::error::Error<>("encode: TypeBody: union_variant_100 variant alternative union_struct_103 is not set",::futils::error::Category::lib);
            }
            if (auto err = std::get<3>((*this).union_variant_100).size.encode(w)) {
                return err;
            }
        }
            ...
            if(!std::holds_alternative<union_struct_105>(union_variant_100)) {
                return ::futils::error::Error<>("encode: TypeBody: union_variant_100 variant alternative union_struct_105 is not set",::futils::error::Category::lib);
            }
            if (auto err = std::get<5>((*this).union_variant_100).element_type.encode(w)) {
                return err;
            }
            if (auto err = std::get<5>((*this).union_variant_100).length.encode(w)) {
                return err;
            }
        }
        else if (TypeKind::VECTOR==(*this).kind) {
            if(!std::holds_alternative<union_struct_106>(union_variant_100)) {
                return ::futils::error::Error<>("encode: TypeBody: union_variant_100 variant alternative union_struct_106 is not set",::futils::error::Category::lib);
            }
            if (auto err = std::get<6>((*this).union_variant_100).element_type.encode(w)) {
                return err;
            }
        }
        else if (TypeKind::STRUCT==(*this).kind) {
            if(!std::holds_alternative<union_struct_107>(union_variant_100)) {
                return ::futils::error::Error<>("encode: TypeBody: union_variant_100 variant alternative union_struct_107 is not set",::futils::error::Category::lib);
            }
            if (auto err = std::get<7>((*this).union_variant_100).id.encode(w)) {
                return err;
            }
        }
        else if (TypeKind::RECURSIVE_STRUCT==(*this).kind) {
            if(!std::holds_alternative<union_struct_108>(union_variant_100)) {
                return ::futils::error::Error<>("encode: TypeBody: union_variant_100 variant alternative union_struct_108 is not set",::futils::error::Category::lib);
            }
            if (auto err = std::get<8>((*this).union_variant_100).id.encode(w)) {
                return err;
            }
        }
        else if (TypeKind::ENUM==(*this).kind) {
            if(!std::holds_alternative<union_struct_109>(union_variant_100)) {
                return ::futils::error::Error<>("encode: TypeBody: union_variant_100 variant alternative union_struct_109 is not set",::futils::error::Category::lib);
            }
            if (auto err = std::get<9>((*this).union_variant_100).id.encode(w)) {
                return err;
            }
            if (auto err = std::get<9>((*this).union_variant_100).base_type.encode(w)) {
                return err;
            }
        }
        else if (TypeKind::VARIANT==(*this).kind) {
            if(!std::holds_alternative<union_struct_110>(union_variant_100)) {
                return ::futils::error::Error<>("encode: TypeBody: union_variant_100 variant alternative union_struct_110 is not set",::futils::error::Category::lib);
            }
            if (auto err = std::get<10>((*this).union_variant_100).common_type.encode(w)) {
                return err;
            }
            if (auto err = std::get<10>((*this).union_variant_100).members.encode(w)) {
                return err;
            }
            if (auto err = std::get<10>((*this).union_variant_100).related_field.encode(w)) {
                return err;
            }
        }
        else if (TypeKind::OPTIONAL==(*this).kind) {
            if(!std::holds_alternative<union_struct_111>(union_variant_100)) {
                return ::futils::error::Error<>("encode: TypeBody: union_variant_100 variant alternative union_struct_111 is not set",::futils::error::Category::lib);
            }
            if (auto err = std::get<11>((*this).union_variant_100).inner_type.encode(w)) {
                return err;
            }
        }
        else if (TypeKind::PTR==(*this).kind) {
            if(!std::holds_alternative<union_struct_112>(union_variant_100)) {
                return ::futils::error::Error<>("encode: TypeBody: union_variant_100 variant alternative union_struct_112 is not set",::futils::error::Category::lib);
            }
            if (auto err = std::get<12>((*this).union_variant_100).pointee_type.encode(w)) {
                return err;
            }
        }
        else if (TypeKind::RANGE==(*this).kind) {
            if(!std::holds_alternative<union_struct_113>(union_variant_100)) {
                return ::futils::error::Error<>("encode: TypeBody: union_variant_100 variant alternative union_struct_113 is not set",::futils::error::Category::lib);
            }
            if (auto err = std::get<13>((*this).union_variant_100).base_type.encode(w)) {
                return err;
            }
        }
        else if (TypeKind::FUNCTION==(*this).kind) {
            if(!std::holds_alternative<union_struct_114>(union_variant_100)) {
                return ::futils::error::Error<>("encode: TypeBody: union_variant_100 variant alternative union_struct_114 is not set",::futils::error::Category::lib);
            }
            if (auto err = std::get<14>((*this).union_variant_100).return_type.encode(w)) {
                return err;
            }
            if (auto err = std::get<14>((*this).union_variant_100).params.encode(w)) {
                return err;
            }
        }
        return ::futils::error::Error<>();
    ...
    ::futils::error::Error<> TypeBody::decode(::futils::binary::reader& r) {
        ...
        (*this).kind = static_cast<TypeKind>(tmp_189_);
        if (TypeKind::INT==(*this).kind) {
            if(!std::holds_alternative<union_struct_101>(union_variant_100)) {
                union_variant_100 = union_struct_101();
            }
            if (auto err = std::get<1>((*this).union_variant_100).size.decode(r)) {
                return err;
            }
        }
        else if (TypeKind::UINT==(*this).kind) {
            ...
            if (auto err = std::get<2>((*this).union_variant_100).size.decode(r)) {
                return err;
            }
        }
        else if (TypeKind::FLOAT==(*this).kind) {
            ...
            if (auto err = std::get<3>((*this).union_variant_100).size.decode(r)) {
                return err;
            }
        }
        else if (TypeKind::BOOL==(*this).kind) {
            ...
            if (auto err = std::get<5>((*this).union_variant_100).element_type.decode(r)) {
                return err;
            }
            if (auto err = std::get<5>((*this).union_variant_100).length.decode(r)) {
                return err;
            }
        }
        else if (TypeKind::VECTOR==(*this).kind) {
            ...
            if (auto err = std::get<6>((*this).union_variant_100).element_type.decode(r)) {
                return err;
            }
        }
        else if (TypeKind::STRUCT==(*this).kind) {
            ...
            if (auto err = std::get<7>((*this).union_variant_100).id.decode(r)) {
                return err;
            }
        }
        else if (TypeKind::RECURSIVE_STRUCT==(*this).kind) {
            ...
            if (auto err = std::get<8>((*this).union_variant_100).id.decode(r)) {
                return err;
            }
        }
        else if (TypeKind::ENUM==(*this).kind) {
            ...
            if (auto err = std::get<9>((*this).union_variant_100).id.decode(r)) {
                return err;
            }
            if (auto err = std::get<9>((*this).union_variant_100).base_type.decode(r)) {
                return err;
            }
        }
        else if (TypeKind::VARIANT==(*this).kind) {
            ...
            if (auto err = std::get<10>((*this).union_variant_100).common_type.decode(r)) {
                return err;
            }
            if (auto err = std::get<10>((*this).union_variant_100).members.decode(r)) {
                return err;
            }
            if (auto err = std::get<10>((*this).union_variant_100).related_field.decode(r)) {
                return err;
            }
        }
        else if (TypeKind::OPTIONAL==(*this).kind) {
            ...
            if (auto err = std::get<11>((*this).union_variant_100).inner_type.decode(r)) {
                return err;
            }
        }
        else if (TypeKind::PTR==(*this).kind) {
            ...
            if (auto err = std::get<12>((*this).union_variant_100).pointee_type.decode(r)) {
                return err;
            }
        }
        else if (TypeKind::RANGE==(*this).kind) {
            ...
            if (auto err = std::get<13>((*this).union_variant_100).base_type.decode(r)) {
                return err;
            }
        }
        else if (TypeKind::FUNCTION==(*this).kind) {
            ...
            if (auto err = std::get<14>((*this).union_variant_100).return_type.decode(r)) {
                return err;
            }
            if (auto err = std::get<14>((*this).union_variant_100).params.decode(r)) {
                return err;
            }
        }
        return ::futils::error::Error<>();
    ...
    ::futils::error::Error<> ExtendedBinaryModule::encode(::futils::binary::writer& w) const {
        ...
        auto tmp_200_ = (*this).identifiers_len.value();
        if (tmp_200_!=(*this).identifiers.size()) {
            return ::futils::error::Error<>("encode: ExtendedBinaryModule::identifiers: dynamic length is not compatible with its length; tmp_200_!=(*this).identifiers.size()",::futils::error::Category::lib);
        }
        for (auto& tmp_201_ : (*this).identifiers) {
        ...
        auto tmp_202_ = (*this).strings_len.value();
        if (tmp_202_!=(*this).strings.size()) {
            return ::futils::error::Error<>("encode: ExtendedBinaryModule::strings: dynamic length is not compatible with its length; tmp_202_!=(*this).strings.size()",::futils::error::Category::lib);
        }
        for (auto& tmp_203_ : (*this).strings) {
        ...
        auto tmp_204_ = (*this).types_len.value();
        if (tmp_204_!=(*this).types.size()) {
            return ::futils::error::Error<>("encode: ExtendedBinaryModule::types: dynamic length is not compatible with its length; tmp_204_!=(*this).types.size()",::futils::error::Category::lib);
        }
        for (auto& tmp_205_ : (*this).types) {
        ...
        auto tmp_206_ = (*this).statements_len.value();
        if (tmp_206_!=(*this).statements.size()) {
            return ::futils::error::Error<>("encode: ExtendedBinaryModule::statements: dynamic length is not compatible with its length; tmp_206_!=(*this).statements.size()",::futils::error::Category::lib);
        }
        for (auto& tmp_207_ : (*this).statements) {
        ...
        if (tmp_208_!=(*this).expressions.size()) {
            return ::futils::error::Error<>("encode: ExtendedBinaryModule::expressions: dynamic length is not compatible with its length; tmp_208_!=(*this).expressions.size()",::futils::error::Category::lib);
        }
        for (auto& tmp_209_ : (*this).expressions) {
        ...
        auto tmp_210_ = (*this).aliases_len.value();
        if (tmp_210_!=(*this).aliases.size()) {
            return ::futils::error::Error<>("encode: ExtendedBinaryModule::aliases: dynamic length is not compatible with its length; tmp_210_!=(*this).aliases.size()",::futils::error::Category::lib);
        }
        for (auto& tmp_211_ : (*this).aliases) {
    ...
    ::futils::error::Error<> ExtendedBinaryModule::decode(::futils::binary::reader& r) {
        ...
        if (tmp_212_ != ::futils::view::rvec("EBMG",4)) {
        ...
        for (size_t  tmp_215_= 0; tmp_215_<tmp_213_; ++tmp_215_ ) {
            ...
            (*this).identifiers.push_back(std::move(tmp_214_));
        }
        if (auto err = (*this).strings_len.decode(r)) {
            return err;
        }
        auto tmp_216_ = (*this).strings_len.value();
        (*this).strings.clear();
        for (size_t  tmp_218_= 0; tmp_218_<tmp_216_; ++tmp_218_ ) {
            StringLiteral tmp_217_;
            if (auto err = tmp_217_.decode(r)) {
                return err;
            }
            (*this).strings.push_back(std::move(tmp_217_));
        }
        ...
        for (size_t  tmp_221_= 0; tmp_221_<tmp_219_; ++tmp_221_ ) {
            ...
            (*this).types.push_back(std::move(tmp_220_));
        }
        ...
        for (size_t  tmp_224_= 0; tmp_224_<tmp_222_; ++tmp_224_ ) {
            ...
            (*this).statements.push_back(std::move(tmp_223_));
        }
        ...
        for (size_t  tmp_227_= 0; tmp_227_<tmp_225_; ++tmp_227_ ) {
            ...
            (*this).expressions.push_back(std::move(tmp_226_));
        }
        if (auto err = (*this).aliases_len.decode(r)) {
            return err;
        }
        auto tmp_228_ = (*this).aliases_len.value();
        (*this).aliases.clear();
        for (size_t  tmp_230_= 0; tmp_230_<tmp_228_; ++tmp_230_ ) {
            ...
            (*this).aliases.push_back(std::move(tmp_229_));
        }
