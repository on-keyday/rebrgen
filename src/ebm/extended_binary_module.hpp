...
namespace ebm {
    ...
    struct EBM_API LoopStatement{
        ...
        std::variant<std::monostate, union_struct_38, union_struct_39, union_struct_40, union_struct_41> union_variant_37;
