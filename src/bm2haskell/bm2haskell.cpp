...
namespace bm2haskell {
    ...
    std::vector<std::string> eval(const rebgn::Code& code, Context& ctx) {
        ...
        switch (code.op) {
            ...
            case rebgn::AbstractOp::DEFINE_VARIABLE: {
                ...
                auto evaluated = eval(ctx.ref(ref), ctx);
                result.insert(result.end(), evaluated.begin(), evaluated.end() - 1);
                result.push_back(std::format("{} {} = {}", ident, type, evaluated.back()));
    ...
    std::string escape_haskell_keyword(std::string_view str) {
        if (str == "case" || str == "class" || str == "data" || str == "default" || str == "deriving" || str == "do" || str == "else" || str == "foreign" || str == "if" || str == "import" || str == "in" || str == "infix" || str == "infixl" || str == "infixr" || str == "instance" || str == "let" || str == "module" || str == "newtype" || str == "of" || str == "then" || str == "type" || str == "where" || str == "_" || str == "as" || str == "qualified" || str == "hiding" || str == "export" || str == "safe" || str == "unsafe" || str == "forall" || str == "family" || str == "role" || str == "pattern" || str == "static" || str == "stock" || str == "anyclass" || str == "via" || str == "do" || str == "mdo" || str == "rec" || str == "proc" || str == "group" || str == "by" || str == "using" || str == "letrec" || str == "qualifed" || str == "unboxed" || str == "strict" || str == "safe" || str == "unsafe" || str == "interruptible" || str == "ccall" || str == "stdcall" || str == "cplusplus" || str == "jvm" || str == "js" || str == "dotnet" || str == "safe" || str == "unsafe") {
            return std::format("{}_", str);
        }
    ...
    void to_haskell(::futils::binary::writer& w, const rebgn::BinaryModule& bm, const Flags& flags) {
        ...
        ctx.cw.writeln("{- Code generated by bm2haskell from https://github.com/on-keyday/rebrgen -}");
        ctx.cw.writeln("import Data.Array");
        ctx.cw.writeln("import Data.Word");
        ctx.cw.writeln("import Data.Int");
        for (size_t j = 0; j < bm.programs.ranges.size(); j++) {
