...
struct Flags : futils::cmdline::templ::HelpOption {
    ...
    void bind(futils::cmdline::option::Context& ctx) {
        ...
        ctx.VarBool(&ebmgen_mode, "ebmgen", "Generate for ebmgen (eliminate unnecessary codegen features to speed up generation and reduce binary size)");
...
int Main(Flags& flags, futils::cmdline::option::Context& ctx) {
    ...
    if (!flags.ebmgen_mode) {  // if ebmgen mode, no entry point needed
    ...
    locations.ebmgen_mode = flags.ebmgen_mode;
