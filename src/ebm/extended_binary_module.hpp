...
namespace ebm {
    ...
    constexpr const char* to_string(GenerateType e, bool origin_form = false) {
        switch (e) {
            case GenerateType::Normal:
                return origin_form ? "Normal" : "Normal";
            case GenerateType::Encode:
                return origin_form ? "Encode" : "Encode";
            case GenerateType::Decode:
                return origin_form ? "Decode" : "Decode";
        }
        return "";
    }
    ...
    constexpr const char* to_string(BinaryOp e, bool origin_form = false) {
        switch (e) {
            case BinaryOp::mul:
                return origin_form ? "mul" : "*";
            case BinaryOp::div:
                return origin_form ? "div" : "/";
            case BinaryOp::mod:
                return origin_form ? "mod" : "%";
            case BinaryOp::left_shift:
                return origin_form ? "left_shift" : "<<";
            case BinaryOp::right_shift:
                return origin_form ? "right_shift" : ">>";
            case BinaryOp::bit_and:
                return origin_form ? "bit_and" : "&";
            case BinaryOp::add:
                return origin_form ? "add" : "+";
            case BinaryOp::sub:
                return origin_form ? "sub" : "-";
            case BinaryOp::bit_or:
                return origin_form ? "bit_or" : "|";
            case BinaryOp::bit_xor:
                return origin_form ? "bit_xor" : "^";
            case BinaryOp::equal:
                return origin_form ? "equal" : "==";
            case BinaryOp::not_equal:
                return origin_form ? "not_equal" : "!=";
            case BinaryOp::less:
                return origin_form ? "less" : "<";
            case BinaryOp::less_or_eq:
                return origin_form ? "less_or_eq" : "<=";
            case BinaryOp::greater:
                return origin_form ? "greater" : ">";
            case BinaryOp::greater_or_eq:
                return origin_form ? "greater_or_eq" : ">=";
            case BinaryOp::logical_and:
                return origin_form ? "logical_and" : "&&";
            case BinaryOp::logical_or:
                return origin_form ? "logical_or" : "||";
        }
        return "";
    }
    ...
    constexpr const char* to_string(UnaryOp e, bool origin_form = false) {
        switch (e) {
            case UnaryOp::logical_not:
                return origin_form ? "logical_not" : "!";
            case UnaryOp::minus_sign:
                return origin_form ? "minus_sign" : "-";
            case UnaryOp::bit_not:
                return origin_form ? "bit_not" : "~";
        }
        return "";
    }
    ...
    constexpr const char* to_string(Endian e, bool origin_form = false) {
        switch (e) {
            case Endian::unspec:
                return origin_form ? "unspec" : "unspec";
            case Endian::big:
                return origin_form ? "big" : "big";
            case Endian::little:
                return origin_form ? "little" : "little";
            case Endian::dynamic:
                return origin_form ? "dynamic" : "dynamic";
            case Endian::native:
                return origin_form ? "native" : "native";
        }
        return "";
    }
    ...
    constexpr const char* to_string(ExpressionKind e, bool origin_form = false) {
        switch (e) {
            case ExpressionKind::LITERAL_INT:
                return origin_form ? "LITERAL_INT" : "LITERAL_INT";
            case ExpressionKind::LITERAL_INT64:
                return origin_form ? "LITERAL_INT64" : "LITERAL_INT64";
            case ExpressionKind::LITERAL_BOOL:
                return origin_form ? "LITERAL_BOOL" : "LITERAL_BOOL";
            case ExpressionKind::LITERAL_STRING:
                return origin_form ? "LITERAL_STRING" : "LITERAL_STRING";
            case ExpressionKind::LITERAL_TYPE:
                return origin_form ? "LITERAL_TYPE" : "LITERAL_TYPE";
            case ExpressionKind::LITERAL_CHAR:
                return origin_form ? "LITERAL_CHAR" : "LITERAL_CHAR";
            case ExpressionKind::IDENTIFIER:
                return origin_form ? "IDENTIFIER" : "IDENTIFIER";
            case ExpressionKind::BINARY_OP:
                return origin_form ? "BINARY_OP" : "BINARY_OP";
            case ExpressionKind::UNARY_OP:
                return origin_form ? "UNARY_OP" : "UNARY_OP";
            case ExpressionKind::CALL:
                return origin_form ? "CALL" : "CALL";
            case ExpressionKind::INDEX_ACCESS:
                return origin_form ? "INDEX_ACCESS" : "INDEX_ACCESS";
            case ExpressionKind::MEMBER_ACCESS:
                return origin_form ? "MEMBER_ACCESS" : "MEMBER_ACCESS";
            case ExpressionKind::TYPE_CAST:
                return origin_form ? "TYPE_CAST" : "TYPE_CAST";
            case ExpressionKind::RANGE:
                return origin_form ? "RANGE" : "RANGE";
            case ExpressionKind::DEFAULT_VALUE:
                return origin_form ? "DEFAULT_VALUE" : "DEFAULT_VALUE";
            case ExpressionKind::IS_LITTLE_ENDIAN:
                return origin_form ? "IS_LITTLE_ENDIAN" : "IS_LITTLE_ENDIAN";
            case ExpressionKind::GET_STREAM_OFFSET:
                return origin_form ? "GET_STREAM_OFFSET" : "GET_STREAM_OFFSET";
            case ExpressionKind::GET_REMAINING_BYTES:
                return origin_form ? "GET_REMAINING_BYTES" : "GET_REMAINING_BYTES";
            case ExpressionKind::CAN_READ_STREAM:
                return origin_form ? "CAN_READ_STREAM" : "CAN_READ_STREAM";
            case ExpressionKind::ARRAY_SIZE:
                return origin_form ? "ARRAY_SIZE" : "ARRAY_SIZE";
            case ExpressionKind::IS_ERROR:
                return origin_form ? "IS_ERROR" : "IS_ERROR";
            case ExpressionKind::MAX_VALUE:
                return origin_form ? "MAX_VALUE" : "MAX_VALUE";
            case ExpressionKind::READ_DATA:
                return origin_form ? "READ_DATA" : "READ_DATA";
            case ExpressionKind::WRITE_DATA:
                return origin_form ? "WRITE_DATA" : "WRITE_DATA";
            case ExpressionKind::CONDITIONAL_STATEMENT:
                return origin_form ? "CONDITIONAL_STATEMENT" : "CONDITIONAL_STATEMENT";
            case ExpressionKind::CONDITIONAL:
                return origin_form ? "CONDITIONAL" : "CONDITIONAL";
            case ExpressionKind::AVAILABLE:
                return origin_form ? "AVAILABLE" : "AVAILABLE";
            case ExpressionKind::SIZEOF:
                return origin_form ? "SIZEOF" : "SIZEOF";
            case ExpressionKind::SUB_RANGE_INIT:
                return origin_form ? "SUB_RANGE_INIT" : "SUB_RANGE_INIT";
            case ExpressionKind::OR_COND:
                return origin_form ? "OR_COND" : "OR_COND";
            case ExpressionKind::ADDRESS_OF:
                return origin_form ? "ADDRESS_OF" : "ADDRESS_OF";
            case ExpressionKind::OPTIONAL_OF:
                return origin_form ? "OPTIONAL_OF" : "OPTIONAL_OF";
            case ExpressionKind::SETTER_STATUS:
                return origin_form ? "SETTER_STATUS" : "SETTER_STATUS";
        }
        return "";
    }
    ...
    constexpr const char* to_string(SetterStatus e, bool origin_form = false) {
        switch (e) {
            case SetterStatus::SUCCESS:
                return origin_form ? "SUCCESS" : "SUCCESS";
            case SetterStatus::FAILED:
                return origin_form ? "FAILED" : "FAILED";
        }
        return "";
    }
    ...
    constexpr const char* to_string(LoopType e, bool origin_form = false) {
        switch (e) {
            case LoopType::INFINITE:
                return origin_form ? "INFINITE" : "INFINITE";
            case LoopType::WHILE:
                return origin_form ? "WHILE" : "WHILE";
            case LoopType::FOR_EACH:
                return origin_form ? "FOR_EACH" : "FOR_EACH";
            case LoopType::FOR:
                return origin_form ? "FOR" : "FOR";
        }
        return "";
    }
    ...
    constexpr const char* to_string(SubByteRangeType e, bool origin_form = false) {
        switch (e) {
            case SubByteRangeType::bytes:
                return origin_form ? "bytes" : "bytes";
            case SubByteRangeType::seek_bytes:
                return origin_form ? "seek_bytes" : "seek_bytes";
            case SubByteRangeType::expression:
                return origin_form ? "expression" : "expression";
        }
        return "";
    }
    ...
    constexpr const char* to_string(LoweringType e, bool origin_form = false) {
        switch (e) {
            case LoweringType::NAIVE:
                return origin_form ? "NAIVE" : "NAIVE";
            case LoweringType::C_LIKE:
                return origin_form ? "C_LIKE" : "C_LIKE";
            case LoweringType::BIT_STREAM:
                return origin_form ? "BIT_STREAM" : "BIT_STREAM";
            case LoweringType::ASSEMBLY:
                return origin_form ? "ASSEMBLY" : "ASSEMBLY";
        }
        return "";
    }
    ...
    constexpr const char* to_string(StatementKind e, bool origin_form = false) {
        switch (e) {
            case StatementKind::BLOCK:
                return origin_form ? "BLOCK" : "BLOCK";
            case StatementKind::ASSIGNMENT:
                return origin_form ? "ASSIGNMENT" : "ASSIGNMENT";
            case StatementKind::YIELD:
                return origin_form ? "YIELD" : "YIELD";
            case StatementKind::APPEND:
                return origin_form ? "APPEND" : "APPEND";
            case StatementKind::RETURN:
                return origin_form ? "RETURN" : "RETURN";
            case StatementKind::ERROR_RETURN:
                return origin_form ? "ERROR_RETURN" : "ERROR_RETURN";
            case StatementKind::ASSERT:
                return origin_form ? "ASSERT" : "ASSERT";
            case StatementKind::READ_DATA:
                return origin_form ? "READ_DATA" : "READ_DATA";
            case StatementKind::WRITE_DATA:
                return origin_form ? "WRITE_DATA" : "WRITE_DATA";
            case StatementKind::SEEK_STREAM:
                return origin_form ? "SEEK_STREAM" : "SEEK_STREAM";
            case StatementKind::IF_STATEMENT:
                return origin_form ? "IF_STATEMENT" : "IF_STATEMENT";
            case StatementKind::LOOP_STATEMENT:
                return origin_form ? "LOOP_STATEMENT" : "LOOP_STATEMENT";
            case StatementKind::MATCH_STATEMENT:
                return origin_form ? "MATCH_STATEMENT" : "MATCH_STATEMENT";
            case StatementKind::MATCH_BRANCH:
                return origin_form ? "MATCH_BRANCH" : "MATCH_BRANCH";
            case StatementKind::BREAK:
                return origin_form ? "BREAK" : "BREAK";
            case StatementKind::CONTINUE:
                return origin_form ? "CONTINUE" : "CONTINUE";
            case StatementKind::FUNCTION_DECL:
                return origin_form ? "FUNCTION_DECL" : "FUNCTION_DECL";
            case StatementKind::VARIABLE_DECL:
                return origin_form ? "VARIABLE_DECL" : "VARIABLE_DECL";
            case StatementKind::FIELD_DECL:
                return origin_form ? "FIELD_DECL" : "FIELD_DECL";
            case StatementKind::ENUM_DECL:
                return origin_form ? "ENUM_DECL" : "ENUM_DECL";
            case StatementKind::ENUM_MEMBER_DECL:
                return origin_form ? "ENUM_MEMBER_DECL" : "ENUM_MEMBER_DECL";
            case StatementKind::STRUCT_DECL:
                return origin_form ? "STRUCT_DECL" : "STRUCT_DECL";
            case StatementKind::UNION_DECL:
                return origin_form ? "UNION_DECL" : "UNION_DECL";
            case StatementKind::UNION_MEMBER_DECL:
                return origin_form ? "UNION_MEMBER_DECL" : "UNION_MEMBER_DECL";
            case StatementKind::PROGRAM_DECL:
                return origin_form ? "PROGRAM_DECL" : "PROGRAM_DECL";
            case StatementKind::PROPERTY_DECL:
                return origin_form ? "PROPERTY_DECL" : "PROPERTY_DECL";
            case StatementKind::PROPERTY_MEMBER_DECL:
                return origin_form ? "PROPERTY_MEMBER_DECL" : "PROPERTY_MEMBER_DECL";
            case StatementKind::METADATA:
                return origin_form ? "METADATA" : "METADATA";
            case StatementKind::IMPORT_MODULE:
                return origin_form ? "IMPORT_MODULE" : "IMPORT_MODULE";
            case StatementKind::EXPRESSION:
                return origin_form ? "EXPRESSION" : "EXPRESSION";
            case StatementKind::ERROR_REPORT:
                return origin_form ? "ERROR_REPORT" : "ERROR_REPORT";
            case StatementKind::LOWERED_STATEMENTS:
                return origin_form ? "LOWERED_STATEMENTS" : "LOWERED_STATEMENTS";
            case StatementKind::SUB_BYTE_RANGE:
                return origin_form ? "SUB_BYTE_RANGE" : "SUB_BYTE_RANGE";
        }
        return "";
    }
    ...
    constexpr const char* to_string(StreamType e, bool origin_form = false) {
        switch (e) {
            case StreamType::INPUT:
                return origin_form ? "INPUT" : "INPUT";
            case StreamType::OUTPUT:
                return origin_form ? "OUTPUT" : "OUTPUT";
        }
        return "";
    }
    ...
    constexpr const char* to_string(SizeUnit e, bool origin_form = false) {
        switch (e) {
            case SizeUnit::UNKNOWN:
                return origin_form ? "UNKNOWN" : "UNKNOWN";
            case SizeUnit::BIT_FIXED:
                return origin_form ? "BIT_FIXED" : "BIT_FIXED";
            case SizeUnit::BYTE_FIXED:
                return origin_form ? "BYTE_FIXED" : "BYTE_FIXED";
            case SizeUnit::ELEMENT_FIXED:
                return origin_form ? "ELEMENT_FIXED" : "ELEMENT_FIXED";
            case SizeUnit::BIT_DYNAMIC:
                return origin_form ? "BIT_DYNAMIC" : "BIT_DYNAMIC";
            case SizeUnit::BYTE_DYNAMIC:
                return origin_form ? "BYTE_DYNAMIC" : "BYTE_DYNAMIC";
            case SizeUnit::ELEMENT_DYNAMIC:
                return origin_form ? "ELEMENT_DYNAMIC" : "ELEMENT_DYNAMIC";
            case SizeUnit::DYNAMIC:
                return origin_form ? "DYNAMIC" : "DYNAMIC";
        }
        return "";
    }
    ...
    constexpr const char* to_string(CastType e, bool origin_form = false) {
        switch (e) {
            case CastType::ENUM_TO_INT:
                return origin_form ? "ENUM_TO_INT" : "ENUM_TO_INT";
            case CastType::INT_TO_ENUM:
                return origin_form ? "INT_TO_ENUM" : "INT_TO_ENUM";
            case CastType::FLOAT_TO_INT_BIT:
                return origin_form ? "FLOAT_TO_INT_BIT" : "FLOAT_TO_INT_BIT";
            case CastType::INT_TO_FLOAT_BIT:
                return origin_form ? "INT_TO_FLOAT_BIT" : "INT_TO_FLOAT_BIT";
            case CastType::VECTOR_TO_ARRAY:
                return origin_form ? "VECTOR_TO_ARRAY" : "VECTOR_TO_ARRAY";
            case CastType::ARRAY_TO_VECTOR:
                return origin_form ? "ARRAY_TO_VECTOR" : "ARRAY_TO_VECTOR";
            case CastType::INT_TO_VECTOR:
                return origin_form ? "INT_TO_VECTOR" : "INT_TO_VECTOR";
            case CastType::INT_TO_ARRAY:
                return origin_form ? "INT_TO_ARRAY" : "INT_TO_ARRAY";
            case CastType::SMALL_INT_TO_LARGE_INT:
                return origin_form ? "SMALL_INT_TO_LARGE_INT" : "SMALL_INT_TO_LARGE_INT";
            case CastType::LARGE_INT_TO_SMALL_INT:
                return origin_form ? "LARGE_INT_TO_SMALL_INT" : "LARGE_INT_TO_SMALL_INT";
            case CastType::SIGNED_TO_UNSIGNED:
                return origin_form ? "SIGNED_TO_UNSIGNED" : "SIGNED_TO_UNSIGNED";
            case CastType::UNSIGNED_TO_SIGNED:
                return origin_form ? "UNSIGNED_TO_SIGNED" : "UNSIGNED_TO_SIGNED";
            case CastType::BOOL_TO_INT:
                return origin_form ? "BOOL_TO_INT" : "BOOL_TO_INT";
            case CastType::INT_TO_BOOL:
                return origin_form ? "INT_TO_BOOL" : "INT_TO_BOOL";
            case CastType::STRUCT_TO_RECURSIVE_STRUCT:
                return origin_form ? "STRUCT_TO_RECURSIVE_STRUCT" : "STRUCT_TO_RECURSIVE_STRUCT";
            case CastType::RECURSIVE_STRUCT_TO_STRUCT:
                return origin_form ? "RECURSIVE_STRUCT_TO_STRUCT" : "RECURSIVE_STRUCT_TO_STRUCT";
            case CastType::OTHER:
                return origin_form ? "OTHER" : "OTHER";
        }
        return "";
    }
    ...
    constexpr const char* to_string(MergeMode e, bool origin_form = false) {
        switch (e) {
            case MergeMode::UNCOMMON_TYPE:
                return origin_form ? "UNCOMMON_TYPE" : "UNCOMMON_TYPE";
            case MergeMode::COMMON_TYPE:
                return origin_form ? "COMMON_TYPE" : "COMMON_TYPE";
            case MergeMode::STRICT_TYPE:
                return origin_form ? "STRICT_TYPE" : "STRICT_TYPE";
        }
        return "";
    }
    ...
    constexpr const char* to_string(TypeKind e, bool origin_form = false) {
        switch (e) {
            case TypeKind::INT:
                return origin_form ? "INT" : "INT";
            case TypeKind::UINT:
                return origin_form ? "UINT" : "UINT";
            case TypeKind::FLOAT:
                return origin_form ? "FLOAT" : "FLOAT";
            case TypeKind::STRUCT:
                return origin_form ? "STRUCT" : "STRUCT";
            case TypeKind::RECURSIVE_STRUCT:
                return origin_form ? "RECURSIVE_STRUCT" : "RECURSIVE_STRUCT";
            case TypeKind::BOOL:
                return origin_form ? "BOOL" : "BOOL";
            case TypeKind::VOID:
                return origin_form ? "VOID" : "VOID";
            case TypeKind::META:
                return origin_form ? "META" : "META";
            case TypeKind::ENUM:
                return origin_form ? "ENUM" : "ENUM";
            case TypeKind::ARRAY:
                return origin_form ? "ARRAY" : "ARRAY";
            case TypeKind::VECTOR:
                return origin_form ? "VECTOR" : "VECTOR";
            case TypeKind::VARIANT:
                return origin_form ? "VARIANT" : "VARIANT";
            case TypeKind::RANGE:
                return origin_form ? "RANGE" : "RANGE";
            case TypeKind::ENCODER_RETURN:
                return origin_form ? "ENCODER_RETURN" : "ENCODER_RETURN";
            case TypeKind::DECODER_RETURN:
                return origin_form ? "DECODER_RETURN" : "DECODER_RETURN";
            case TypeKind::ENCODER_INPUT:
                return origin_form ? "ENCODER_INPUT" : "ENCODER_INPUT";
            case TypeKind::DECODER_INPUT:
                return origin_form ? "DECODER_INPUT" : "DECODER_INPUT";
            case TypeKind::PROPERTY_SETTER_RETURN:
                return origin_form ? "PROPERTY_SETTER_RETURN" : "PROPERTY_SETTER_RETURN";
            case TypeKind::OPTIONAL:
                return origin_form ? "OPTIONAL" : "OPTIONAL";
            case TypeKind::PTR:
                return origin_form ? "PTR" : "PTR";
            case TypeKind::FUNCTION:
                return origin_form ? "FUNCTION" : "FUNCTION";
        }
        return "";
    }
    ...
    constexpr const char* to_string(AliasHint e, bool origin_form = false) {
        switch (e) {
            case AliasHint::IDENTIFIER:
                return origin_form ? "IDENTIFIER" : "IDENTIFIER";
            case AliasHint::STRING:
                return origin_form ? "STRING" : "STRING";
            case AliasHint::TYPE:
                return origin_form ? "TYPE" : "TYPE";
            case AliasHint::EXPRESSION:
                return origin_form ? "EXPRESSION" : "EXPRESSION";
            case AliasHint::STATEMENT:
                return origin_form ? "STATEMENT" : "STATEMENT";
            case AliasHint::ALIAS:
                return origin_form ? "ALIAS" : "ALIAS";
        }
        return "";
    }
