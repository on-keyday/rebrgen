...
namespace ebm2all {
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Statement_RESERVE_DATA_before ebm2all::Context_Statement_RESERVE_DATA_before
    ...
    #define EBM2ALL_CODEGEN_CONTEXT_Statement_RESERVE_DATA_after ebm2all::Context_Statement_RESERVE_DATA_after
