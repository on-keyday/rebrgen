...
#& "./tool/gen_template" --config --config-file "src/bm2$LANG_NAME/config.json" --hook-dir "src\bm2$LANG_NAME/hook"  $DEBUG_OPTION | Out-File "src/bm2$LANG_NAME/config.json" -Encoding utf8
