...
def generate_web_glue_files(tools: list[dict], output_dir):
    ...
    WORKER_FACTORY = b"export const workers = Object.freeze({\n"
    COPY_WASM = b""
    for tool in tools:
...
"""
    ...
    with open(f"{output_dir}/ebm_worker.js", "wb") as f:
