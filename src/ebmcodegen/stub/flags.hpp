...
namespace ebmcodegen {
    auto flag_description_json(futils::cmdline::option::Context& ctx, const char* lang_name, const char* ui_lang_name, const char* lsp_name, const char* webworker_name, auto&& web_filtered) {
