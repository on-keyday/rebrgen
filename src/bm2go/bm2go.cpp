...
namespace bm2go {
    ...
    EvalResult eval(const rebgn::Code& code, Context& ctx) {
        ...
        case rebgn::AbstractOp::IS_LITTLE_ENDIAN: {
            ...
            if(fallback.value() != 0) {
                ...
                result = make_eval_result("binary.NativeEndian.Uint16([]byte{0x12, 0x34}) == uint16(0x3412)");
            }
            break;
        }
        ...
        case rebgn::AbstractOp::ARRAY_SIZE: {
            ...
            result = make_eval_result(futils::strutil::concat<std::string>("size"));
            break;
        }
    ...
    void inner_function(Context& ctx, TmpCodeWriter& w, rebgn::Range range) {
        ...
        for(size_t i = range.start; i < range.end; i++) {
            ...
            case rebgn::AbstractOp::SWITCH_UNION: {
                ...
                w.writeln("if _,ok := ",union_field_ident.result,".(*",union_member_ident,");ok {");
    ...
    void to_go(::futils::binary::writer& w, const rebgn::BinaryModule& bm, const Flags& flags,Output& output) {
        ...
        // search metadata
        {
            auto& w = ctx.cw;
            // load hook: file_top
            w.writeln("// Code generated by bm2go in https://github.com/on-keyday/rebrgen, DO NOT EDIT.");
